...
func resourceObjectRouterPrefixList6Create(d *schema.ResourceData, m interface{}) error {
	...
	if update_if_exist && mkey_ok {
		...
		if err == nil && o != nil {
			existing = true
			// update if existing
			o, err = c.UpdateObjectRouterPrefixList6(obj, mkey, paradict, wsParams)
			if err != nil {
	...
	if !existing {
		_, err = c.CreateObjectRouterPrefixList6(obj, paradict, wsParams)
		if err != nil {
...
func resourceObjectRouterPrefixList6Update(d *schema.ResourceData, m interface{}) error {
	...
	_, err = c.UpdateObjectRouterPrefixList6(obj, mkey, paradict, wsParams)
	if err != nil {
		return fmt.Errorf("Error updating ObjectRouterPrefixList6 resource: %v", err)
	}
...
func resourceObjectRouterPrefixList6Delete(d *schema.ResourceData, m interface{}) error {
	...
	err = c.DeleteObjectRouterPrefixList6(mkey, paradict, wsParams)
	if err != nil {
