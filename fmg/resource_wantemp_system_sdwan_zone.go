...
func resourceWantempSystemSdwanZoneCreate(d *schema.ResourceData, m interface{}) error {
	...
	if update_if_exist && mkey_ok {
		...
		if err == nil && o != nil {
			existing = true
			// update if existing
			o, err = c.UpdateWantempSystemSdwanZone(obj, mkey, paradict, wsParams)
			if err != nil {
	...
	if !existing {
		_, err = c.CreateWantempSystemSdwanZone(obj, paradict, wsParams)
		if err != nil {
...
func resourceWantempSystemSdwanZoneUpdate(d *schema.ResourceData, m interface{}) error {
	...
	_, err = c.UpdateWantempSystemSdwanZone(obj, mkey, paradict, wsParams)
	if err != nil {
		return fmt.Errorf("Error updating WantempSystemSdwanZone resource: %v", err)
	}
...
func resourceWantempSystemSdwanZoneDelete(d *schema.ResourceData, m interface{}) error {
	...
	err = c.DeleteWantempSystemSdwanZone(mkey, paradict, wsParams)
	if err != nil {
