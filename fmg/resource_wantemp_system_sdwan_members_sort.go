...
func resourceWantempSystemSdwanMembersSort() *schema.Resource {
	return &schema.Resource{
		Create: resourceWantempSystemSdwanMembersSortCreateUpdate,
		Read:   resourceWantempSystemSdwanMembersSortRead,
		Update: resourceWantempSystemSdwanMembersSortCreateUpdate,
		Delete: schema.Noop,
...
func resourceWantempSystemSdwanMembersSortCreateUpdate(d *schema.ResourceData, m interface{}) (err error) {
	...
	err = c.CreateUpdateWantempSystemSdwanMembersSort(&input_model)
	if err != nil {
		return fmt.Errorf("Error sorting WantempSystemSdwanMembers: %s", err)
	}

	d.SetId(sortby + sortdirection)

	return resourceWantempSystemSdwanMembersSortRead(d, m)
}

func resourceWantempSystemSdwanMembersSortRead(d *schema.ResourceData, m interface{}) error {
	mkey := d.Id()
	...
	sorted, o, err := c.ReadWantempSystemSdwanMembersSort(&input_model)
	if err != nil {
		return fmt.Errorf("Error reading WantempSystemSdwanMembers sort status: %s %s", err, mkey)
	}
	...
	if o != nil {
		if err := d.Set("state_list", o); err != nil {
			log.Printf("[WARN] Error reading WantempSystemSdwanMembers List for (%s): %s", d.Id(), err)
		}
	} else {
