...
func resourcePackagesFirewallAcl6MoveUpdate(d *schema.ResourceData, m interface{}) error {
	...
	_, err = c.UpdatePackagesFirewallAcl6Move(obj, mkey, paradict, wsParams)
	if err != nil {
	...
	d.SetId("PackagesFirewallAcl6Move" + "_" + pkg_folder_path + "_" + pkg + "_" + acl6 + "_" + target)
