...
func resourceObjectWirelessControllerAccessControlListLayer3Ipv6RulesSort() *schema.Resource {
	return &schema.Resource{
		Create: resourceObjectWirelessControllerAccessControlListLayer3Ipv6RulesSortCreateUpdate,
		Read:   resourceObjectWirelessControllerAccessControlListLayer3Ipv6RulesSortRead,
		Update: resourceObjectWirelessControllerAccessControlListLayer3Ipv6RulesSortCreateUpdate,
		Delete: schema.Noop,
...
func resourceObjectWirelessControllerAccessControlListLayer3Ipv6RulesSortCreateUpdate(d *schema.ResourceData, m interface{}) (err error) {
	...
	err = c.CreateUpdateObjectWirelessControllerAccessControlListLayer3Ipv6RulesSort(&input_model)
	if err != nil {
		return fmt.Errorf("Error sorting ObjectWirelessControllerAccessControlListLayer3Ipv6Rules: %s", err)
	}

	d.SetId(sortby + sortdirection)

	return resourceObjectWirelessControllerAccessControlListLayer3Ipv6RulesSortRead(d, m)
}

func resourceObjectWirelessControllerAccessControlListLayer3Ipv6RulesSortRead(d *schema.ResourceData, m interface{}) error {
	mkey := d.Id()
	...
	sorted, o, err := c.ReadObjectWirelessControllerAccessControlListLayer3Ipv6RulesSort(&input_model)
	if err != nil {
		return fmt.Errorf("Error reading ObjectWirelessControllerAccessControlListLayer3Ipv6Rules sort status: %s %s", err, mkey)
	}
	...
	if o != nil {
		if err := d.Set("state_list", o); err != nil {
			log.Printf("[WARN] Error reading ObjectWirelessControllerAccessControlListLayer3Ipv6Rules List for (%s): %s", d.Id(), err)
		}
	} else {
