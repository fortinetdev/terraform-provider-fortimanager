...
func resourceWantempSystemVirtualWanLinkNeighborCreate(d *schema.ResourceData, m interface{}) error {
	...
	mkey_tf, mkey_ok := d.GetOk("sla_id")
	...
	if update_if_exist && mkey_ok {
		...
		if err == nil && o != nil {
			existing = true
			// update if existing
			o, err = c.UpdateWantempSystemVirtualWanLinkNeighbor(obj, mkey, paradict, wsParams)
			if err != nil {
	...
	if !existing {
		_, err = c.CreateWantempSystemVirtualWanLinkNeighbor(obj, paradict, wsParams)
		if err != nil {
...
func resourceWantempSystemVirtualWanLinkNeighborUpdate(d *schema.ResourceData, m interface{}) error {
	...
	_, err = c.UpdateWantempSystemVirtualWanLinkNeighbor(obj, mkey, paradict, wsParams)
	if err != nil {
		return fmt.Errorf("Error updating WantempSystemVirtualWanLinkNeighbor resource: %v", err)
	}
...
func resourceWantempSystemVirtualWanLinkNeighborDelete(d *schema.ResourceData, m interface{}) error {
	...
	err = c.DeleteWantempSystemVirtualWanLinkNeighbor(mkey, paradict, wsParams)
	if err != nil {
