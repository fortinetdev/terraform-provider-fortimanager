...
func resourceObjectCloudOrchestAwstemplateAutoscaleNewVpcCreate(d *schema.ResourceData, m interface{}) error {
	...
	if update_if_exist && mkey_ok {
		...
		if err == nil && o != nil {
			existing = true
			// update if existing
			o, err = c.UpdateObjectCloudOrchestAwstemplateAutoscaleNewVpc(obj, mkey, paradict, wsParams)
			if err != nil {
	...
	if !existing {
		_, err = c.CreateObjectCloudOrchestAwstemplateAutoscaleNewVpc(obj, paradict, wsParams)
		if err != nil {
...
func resourceObjectCloudOrchestAwstemplateAutoscaleNewVpcUpdate(d *schema.ResourceData, m interface{}) error {
	...
	_, err = c.UpdateObjectCloudOrchestAwstemplateAutoscaleNewVpc(obj, mkey, paradict, wsParams)
	if err != nil {
		return fmt.Errorf("Error updating ObjectCloudOrchestAwstemplateAutoscaleNewVpc resource: %v", err)
	}
...
func resourceObjectCloudOrchestAwstemplateAutoscaleNewVpcDelete(d *schema.ResourceData, m interface{}) error {
	...
	err = c.DeleteObjectCloudOrchestAwstemplateAutoscaleNewVpc(mkey, paradict, wsParams)
	if err != nil {
