...
func resourceObjectVpnSslWebPortalBookmarkGroupCreate(d *schema.ResourceData, m interface{}) error {
	...
	if update_if_exist && mkey_ok {
		...
		if err == nil && o != nil {
			existing = true
			// update if existing
			o, err = c.UpdateObjectVpnSslWebPortalBookmarkGroup(obj, mkey, paradict, wsParams)
			if err != nil {
	...
	if !existing {
		_, err = c.CreateObjectVpnSslWebPortalBookmarkGroup(obj, paradict, wsParams)
		if err != nil {
...
func resourceObjectVpnSslWebPortalBookmarkGroupUpdate(d *schema.ResourceData, m interface{}) error {
	...
	_, err = c.UpdateObjectVpnSslWebPortalBookmarkGroup(obj, mkey, paradict, wsParams)
	if err != nil {
		return fmt.Errorf("Error updating ObjectVpnSslWebPortalBookmarkGroup resource: %v", err)
	}
...
func resourceObjectVpnSslWebPortalBookmarkGroupDelete(d *schema.ResourceData, m interface{}) error {
	...
	err = c.DeleteObjectVpnSslWebPortalBookmarkGroup(mkey, paradict, wsParams)
	if err != nil {
