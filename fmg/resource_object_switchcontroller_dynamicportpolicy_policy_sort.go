...
func resourceObjectSwitchControllerDynamicPortPolicyPolicySort() *schema.Resource {
	return &schema.Resource{
		Create: resourceObjectSwitchControllerDynamicPortPolicyPolicySortCreateUpdate,
		Read:   resourceObjectSwitchControllerDynamicPortPolicyPolicySortRead,
		Update: resourceObjectSwitchControllerDynamicPortPolicyPolicySortCreateUpdate,
		Delete: schema.Noop,
...
func resourceObjectSwitchControllerDynamicPortPolicyPolicySortCreateUpdate(d *schema.ResourceData, m interface{}) (err error) {
	...
	err = c.CreateUpdateObjectSwitchControllerDynamicPortPolicyPolicySort(&input_model)
	if err != nil {
		return fmt.Errorf("Error sorting ObjectSwitchControllerDynamicPortPolicyPolicy: %s", err)
	}

	d.SetId(sortby + sortdirection)

	return resourceObjectSwitchControllerDynamicPortPolicyPolicySortRead(d, m)
}

func resourceObjectSwitchControllerDynamicPortPolicyPolicySortRead(d *schema.ResourceData, m interface{}) error {
	mkey := d.Id()
	...
	sorted, o, err := c.ReadObjectSwitchControllerDynamicPortPolicyPolicySort(&input_model)
	if err != nil {
		return fmt.Errorf("Error reading ObjectSwitchControllerDynamicPortPolicyPolicy sort status: %s %s", err, mkey)
	}
	...
	if o != nil {
		if err := d.Set("state_list", o); err != nil {
			log.Printf("[WARN] Error reading ObjectSwitchControllerDynamicPortPolicyPolicy List for (%s): %s", d.Id(), err)
		}
	} else {
