...
func resourcePackagesGlobalFooterPolicyCreate(d *schema.ResourceData, m interface{}) error {
	...
	if update_if_exist && mkey_ok {
		...
		if err == nil && o != nil {
			existing = true
			// update if existing
			o, err = c.UpdatePackagesGlobalFooterPolicy(obj, mkey, paradict, wsParams)
			if err != nil {
...
func flattenPackagesGlobalFooterPolicyExplicitWebProxy(v interface{}, d *schema.ResourceData, pre string) interface{} {
	return flattenStringList(v)
}
...
func flattenPackagesGlobalFooterPolicyLlmProfile(v interface{}, d *schema.ResourceData, pre string) interface{} {
	return flattenStringList(v)
}
...
func refreshObjectPackagesGlobalFooterPolicy(d *schema.ResourceData, o map[string]interface{}) error {
	...
	if err = d.Set("explicit_web_proxy", flattenPackagesGlobalFooterPolicyExplicitWebProxy(o["explicit-web-proxy"], d, "explicit_web_proxy")); err != nil {
		if vv, ok := fortiAPIPatch(o["explicit-web-proxy"], "PackagesGlobalFooterPolicy-ExplicitWebProxy"); ok {
	...
	if err = d.Set("llm_profile", flattenPackagesGlobalFooterPolicyLlmProfile(o["llm-profile"], d, "llm_profile")); err != nil {
		if vv, ok := fortiAPIPatch(o["llm-profile"], "PackagesGlobalFooterPolicy-LlmProfile"); ok {
...
func expandPackagesGlobalFooterPolicyExplicitWebProxy(d *schema.ResourceData, v interface{}, pre string) (interface{}, error) {
	return expandStringList(v.(*schema.Set).List()), nil
}
...
func expandPackagesGlobalFooterPolicyLlmProfile(d *schema.ResourceData, v interface{}, pre string) (interface{}, error) {
	return expandStringList(v.(*schema.Set).List()), nil
}
...
func getObjectPackagesGlobalFooterPolicy(d *schema.ResourceData) (*map[string]interface{}, error) {
	...
	if v, ok := d.GetOk("explicit_web_proxy"); ok || d.HasChange("explicit_web_proxy") {
		t, err := expandPackagesGlobalFooterPolicyExplicitWebProxy(d, v, "explicit_web_proxy")
		if err != nil {
			return &obj, err
		} else if t != nil {
	...
	if v, ok := d.GetOk("llm_profile"); ok || d.HasChange("llm_profile") {
		t, err := expandPackagesGlobalFooterPolicyLlmProfile(d, v, "llm_profile")
		if err != nil {
			return &obj, err
		} else if t != nil {
			obj["llm-profile"] = t
