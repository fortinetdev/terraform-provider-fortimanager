...
func resourceObjectWirelessControllerHotspot20IconIconListCreate(d *schema.ResourceData, m interface{}) error {
	...
	if update_if_exist && mkey_ok {
		...
		if err == nil && o != nil {
			existing = true
			// update if existing
			o, err = c.UpdateObjectWirelessControllerHotspot20IconIconList(obj, mkey, paradict, wsParams)
			if err != nil {
	...
	if !existing {
		_, err = c.CreateObjectWirelessControllerHotspot20IconIconList(obj, paradict, wsParams)
		if err != nil {
...
func resourceObjectWirelessControllerHotspot20IconIconListUpdate(d *schema.ResourceData, m interface{}) error {
	...
	_, err = c.UpdateObjectWirelessControllerHotspot20IconIconList(obj, mkey, paradict, wsParams)
	if err != nil {
		return fmt.Errorf("Error updating ObjectWirelessControllerHotspot20IconIconList resource: %v", err)
	}
...
func resourceObjectWirelessControllerHotspot20IconIconListDelete(d *schema.ResourceData, m interface{}) error {
	...
	err = c.DeleteObjectWirelessControllerHotspot20IconIconList(mkey, paradict, wsParams)
	if err != nil {
