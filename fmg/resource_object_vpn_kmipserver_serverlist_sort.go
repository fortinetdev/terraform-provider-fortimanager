...
func resourceObjectVpnKmipServerServerListSort() *schema.Resource {
	return &schema.Resource{
		Create: resourceObjectVpnKmipServerServerListSortCreateUpdate,
		Read:   resourceObjectVpnKmipServerServerListSortRead,
		Update: resourceObjectVpnKmipServerServerListSortCreateUpdate,
		Delete: schema.Noop,
...
func resourceObjectVpnKmipServerServerListSortCreateUpdate(d *schema.ResourceData, m interface{}) (err error) {
	...
	err = c.CreateUpdateObjectVpnKmipServerServerListSort(&input_model)
	if err != nil {
		return fmt.Errorf("Error sorting ObjectVpnKmipServerServerList: %s", err)
	}

	d.SetId(sortby + sortdirection)

	return resourceObjectVpnKmipServerServerListSortRead(d, m)
}

func resourceObjectVpnKmipServerServerListSortRead(d *schema.ResourceData, m interface{}) error {
	mkey := d.Id()
	...
	sorted, o, err := c.ReadObjectVpnKmipServerServerListSort(&input_model)
	if err != nil {
		return fmt.Errorf("Error reading ObjectVpnKmipServerServerList sort status: %s %s", err, mkey)
	}
	...
	if o != nil {
		if err := d.Set("state_list", o); err != nil {
			log.Printf("[WARN] Error reading ObjectVpnKmipServerServerList List for (%s): %s", d.Id(), err)
		}
	} else {
