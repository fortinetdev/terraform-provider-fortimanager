...
func resourceObjectUserRadiusCreate(d *schema.ResourceData, m interface{}) error {
	...
	if update_if_exist && mkey_ok {
		...
		if err == nil && o != nil {
			existing = true
			// update if existing
			o, err = c.UpdateObjectUserRadius(obj, mkey, paradict, wsParams)
			if err != nil {
	...
	if !existing {
		_, err = c.CreateObjectUserRadius(obj, paradict, wsParams)
		if err != nil {
...
func resourceObjectUserRadiusUpdate(d *schema.ResourceData, m interface{}) error {
	...
	_, err = c.UpdateObjectUserRadius(obj, mkey, paradict, wsParams)
	if err != nil {
		return fmt.Errorf("Error updating ObjectUserRadius resource: %v", err)
	}
...
func resourceObjectUserRadiusDelete(d *schema.ResourceData, m interface{}) error {
	...
	err = c.DeleteObjectUserRadius(mkey, paradict, wsParams)
	if err != nil {
...
func flattenObjectUserRadiusAccountingServer(v interface{}, d *schema.ResourceData, pre string) []map[string]interface{} {
	...
	for _, r := range l {
		...
		if _, ok := i["vrf-select"]; ok {
			v := flattenObjectUserRadiusAccountingServerVrfSelect(i["vrf-select"], d, pre_append)
			tmp["vrf_select"] = fortiAPISubPartPatch(v, "ObjectUserRadius-AccountingServer-VrfSelect")
		}
...
func flattenObjectUserRadiusAccountingServerVrfSelect(v interface{}, d *schema.ResourceData, pre string) interface{} {
	return v
}
...
func flattenObjectUserRadiusDynamicMapping(v interface{}, d *schema.ResourceData, pre string) []map[string]interface{} {
	...
	for _, r := range l {
		...
		if _, ok := i["fabric-force-sync"]; ok {
			v := flattenObjectUserRadiusDynamicMappingFabricForceSync(i["fabric-force-sync"], d, pre_append)
			tmp["fabric_force_sync"] = fortiAPISubPartPatch(v, "ObjectUserRadius-DynamicMapping-FabricForceSync")
		}

		pre_append = pre + "." + strconv.Itoa(con) + "." + "fabric_object"
		if _, ok := i["fabric-object"]; ok {
			v := flattenObjectUserRadiusDynamicMappingFabricObject(i["fabric-object"], d, pre_append)
			tmp["fabric_object"] = fortiAPISubPartPatch(v, "ObjectUserRadius-DynamicMapping-FabricObject")
		}

		pre_append = pre + "." + strconv.Itoa(con) + "." + "fabric_object_source"
		if _, ok := i["fabric-object-source"]; ok {
			v := flattenObjectUserRadiusDynamicMappingFabricObjectSource(i["fabric-object-source"], d, pre_append)
			tmp["fabric_object_source"] = fortiAPISubPartPatch(v, "ObjectUserRadius-DynamicMapping-FabricObjectSource")
		}
		...
		if _, ok := i["require-message-authenticator"]; ok {
			v := flattenObjectUserRadiusDynamicMappingRequireMessageAuthenticator(i["require-message-authenticator"], d, pre_append)
			tmp["require_message_authenticator"] = fortiAPISubPartPatch(v, "ObjectUserRadius-DynamicMapping-RequireMessageAuthenticator")
		}
		...
		if _, ok := i["uuid"]; ok {
			v := flattenObjectUserRadiusDynamicMappingUuid(i["uuid"], d, pre_append)
			tmp["uuid"] = fortiAPISubPartPatch(v, "ObjectUserRadius-DynamicMapping-Uuid")
		}

		pre_append = pre + "." + strconv.Itoa(con) + "." + "vrf_select"
		if _, ok := i["vrf-select"]; ok {
			v := flattenObjectUserRadiusDynamicMappingVrfSelect(i["vrf-select"], d, pre_append)
			tmp["vrf_select"] = fortiAPISubPartPatch(v, "ObjectUserRadius-DynamicMapping-VrfSelect")
		}
...
func flattenObjectUserRadiusDynamicMappingAccountingServer(v interface{}, d *schema.ResourceData, pre string) []map[string]interface{} {
	...
	for _, r := range l {
		...
		pre_append = pre + "." + strconv.Itoa(con) + "." + "vrf_select"
		if _, ok := i["vrf-select"]; ok {
			v := flattenObjectUserRadiusDynamicMappingAccountingServerVrfSelect(i["vrf-select"], d, pre_append)
...
func flattenObjectUserRadiusDynamicMappingAccountingServerVrfSelect(v interface{}, d *schema.ResourceData, pre string) interface{} {
	return v
}
...
func flattenObjectUserRadiusDynamicMappingFabricForceSync(v interface{}, d *schema.ResourceData, pre string) interface{} {
	return v
}

func flattenObjectUserRadiusDynamicMappingFabricObject(v interface{}, d *schema.ResourceData, pre string) interface{} {
	return v
}

func flattenObjectUserRadiusDynamicMappingFabricObjectSource(v interface{}, d *schema.ResourceData, pre string) interface{} {
	return v
}
...
func flattenObjectUserRadiusDynamicMappingRequireMessageAuthenticator(v interface{}, d *schema.ResourceData, pre string) interface{} {
	return v
}
...
func flattenObjectUserRadiusDynamicMappingUuid(v interface{}, d *schema.ResourceData, pre string) interface{} {
	return v
}

func flattenObjectUserRadiusDynamicMappingVrfSelect(v interface{}, d *schema.ResourceData, pre string) interface{} {
	return v
}

func flattenObjectUserRadiusFabricForceSync(v interface{}, d *schema.ResourceData, pre string) interface{} {
	return v
}

func flattenObjectUserRadiusFabricObject(v interface{}, d *schema.ResourceData, pre string) interface{} {
	return v
}

func flattenObjectUserRadiusFabricObjectSource(v interface{}, d *schema.ResourceData, pre string) interface{} {
	return v
}
...
func flattenObjectUserRadiusRequireMessageAuthenticator(v interface{}, d *schema.ResourceData, pre string) interface{} {
	return v
}
...
func flattenObjectUserRadiusUuid(v interface{}, d *schema.ResourceData, pre string) interface{} {
	return v
}

func flattenObjectUserRadiusVrfSelect(v interface{}, d *schema.ResourceData, pre string) interface{} {
	return v
}
...
func refreshObjectObjectUserRadius(d *schema.ResourceData, o map[string]interface{}) error {
	...
	if err = d.Set("fabric_force_sync", flattenObjectUserRadiusFabricForceSync(o["fabric-force-sync"], d, "fabric_force_sync")); err != nil {
		if vv, ok := fortiAPIPatch(o["fabric-force-sync"], "ObjectUserRadius-FabricForceSync"); ok {
	...
	if err = d.Set("fabric_object", flattenObjectUserRadiusFabricObject(o["fabric-object"], d, "fabric_object")); err != nil {
		if vv, ok := fortiAPIPatch(o["fabric-object"], "ObjectUserRadius-FabricObject"); ok {
	...
	if err = d.Set("fabric_object_source", flattenObjectUserRadiusFabricObjectSource(o["fabric-object-source"], d, "fabric_object_source")); err != nil {
		if vv, ok := fortiAPIPatch(o["fabric-object-source"], "ObjectUserRadius-FabricObjectSource"); ok {
	...
	if err = d.Set("require_message_authenticator", flattenObjectUserRadiusRequireMessageAuthenticator(o["require-message-authenticator"], d, "require_message_authenticator")); err != nil {
		if vv, ok := fortiAPIPatch(o["require-message-authenticator"], "ObjectUserRadius-RequireMessageAuthenticator"); ok {
	...
	if err = d.Set("uuid", flattenObjectUserRadiusUuid(o["uuid"], d, "uuid")); err != nil {
		if vv, ok := fortiAPIPatch(o["uuid"], "ObjectUserRadius-Uuid"); ok {
	...
	if err = d.Set("vrf_select", flattenObjectUserRadiusVrfSelect(o["vrf-select"], d, "vrf_select")); err != nil {
		if vv, ok := fortiAPIPatch(o["vrf-select"], "ObjectUserRadius-VrfSelect"); ok {
...
func expandObjectUserRadiusAccountingServer(d *schema.ResourceData, v interface{}, pre string) (interface{}, error) {
	...
	for _, r := range l {
		...
		pre_append = pre + "." + strconv.Itoa(con) + "." + "vrf_select"
		if _, ok := d.GetOk(pre_append); ok || d.HasChange(pre_append) {
			tmp["vrf-select"], _ = expandObjectUserRadiusAccountingServerVrfSelect(d, i["vrf_select"], pre_append)
		}
...
func expandObjectUserRadiusAccountingServerVrfSelect(d *schema.ResourceData, v interface{}, pre string) (interface{}, error) {
	return v, nil
}
...
func expandObjectUserRadiusDynamicMapping(d *schema.ResourceData, v interface{}, pre string) (interface{}, error) {
	...
	for _, r := range l {
		...
		pre_append = pre + "." + strconv.Itoa(con) + "." + "fabric_force_sync"
		if _, ok := d.GetOk(pre_append); ok || d.HasChange(pre_append) {
			tmp["fabric-force-sync"], _ = expandObjectUserRadiusDynamicMappingFabricForceSync(d, i["fabric_force_sync"], pre_append)
		}

		pre_append = pre + "." + strconv.Itoa(con) + "." + "fabric_object"
		if _, ok := d.GetOk(pre_append); ok || d.HasChange(pre_append) {
			tmp["fabric-object"], _ = expandObjectUserRadiusDynamicMappingFabricObject(d, i["fabric_object"], pre_append)
		}

		pre_append = pre + "." + strconv.Itoa(con) + "." + "fabric_object_source"
		if _, ok := d.GetOk(pre_append); ok || d.HasChange(pre_append) {
			tmp["fabric-object-source"], _ = expandObjectUserRadiusDynamicMappingFabricObjectSource(d, i["fabric_object_source"], pre_append)
		}
		...
		pre_append = pre + "." + strconv.Itoa(con) + "." + "require_message_authenticator"
		if _, ok := d.GetOk(pre_append); ok || d.HasChange(pre_append) {
			tmp["require-message-authenticator"], _ = expandObjectUserRadiusDynamicMappingRequireMessageAuthenticator(d, i["require_message_authenticator"], pre_append)
		}
		...
		pre_append = pre + "." + strconv.Itoa(con) + "." + "uuid"
		if _, ok := d.GetOk(pre_append); ok || d.HasChange(pre_append) {
			tmp["uuid"], _ = expandObjectUserRadiusDynamicMappingUuid(d, i["uuid"], pre_append)
		}

		pre_append = pre + "." + strconv.Itoa(con) + "." + "vrf_select"
		if _, ok := d.GetOk(pre_append); ok || d.HasChange(pre_append) {
			tmp["vrf-select"], _ = expandObjectUserRadiusDynamicMappingVrfSelect(d, i["vrf_select"], pre_append)
		}
...
func expandObjectUserRadiusDynamicMappingAccountingServer(d *schema.ResourceData, v interface{}, pre string) (interface{}, error) {
	...
	for _, r := range l {
		...
		pre_append = pre + "." + strconv.Itoa(con) + "." + "vrf_select"
		if _, ok := d.GetOk(pre_append); ok || d.HasChange(pre_append) {
			tmp["vrf-select"], _ = expandObjectUserRadiusDynamicMappingAccountingServerVrfSelect(d, i["vrf_select"], pre_append)
		}
...
func expandObjectUserRadiusDynamicMappingAccountingServerVrfSelect(d *schema.ResourceData, v interface{}, pre string) (interface{}, error) {
	return v, nil
}
...
func expandObjectUserRadiusDynamicMappingFabricForceSync(d *schema.ResourceData, v interface{}, pre string) (interface{}, error) {
	return v, nil
}

func expandObjectUserRadiusDynamicMappingFabricObject(d *schema.ResourceData, v interface{}, pre string) (interface{}, error) {
	return v, nil
}

func expandObjectUserRadiusDynamicMappingFabricObjectSource(d *schema.ResourceData, v interface{}, pre string) (interface{}, error) {
	return v, nil
}
...
func expandObjectUserRadiusDynamicMappingRequireMessageAuthenticator(d *schema.ResourceData, v interface{}, pre string) (interface{}, error) {
	return v, nil
}
...
func expandObjectUserRadiusDynamicMappingUuid(d *schema.ResourceData, v interface{}, pre string) (interface{}, error) {
	return v, nil
}

func expandObjectUserRadiusDynamicMappingVrfSelect(d *schema.ResourceData, v interface{}, pre string) (interface{}, error) {
	return v, nil
}

func expandObjectUserRadiusFabricForceSync(d *schema.ResourceData, v interface{}, pre string) (interface{}, error) {
	return v, nil
}

func expandObjectUserRadiusFabricObject(d *schema.ResourceData, v interface{}, pre string) (interface{}, error) {
	return v, nil
}

func expandObjectUserRadiusFabricObjectSource(d *schema.ResourceData, v interface{}, pre string) (interface{}, error) {
	return v, nil
}
...
func expandObjectUserRadiusRequireMessageAuthenticator(d *schema.ResourceData, v interface{}, pre string) (interface{}, error) {
	return v, nil
}
...
func expandObjectUserRadiusUuid(d *schema.ResourceData, v interface{}, pre string) (interface{}, error) {
	return v, nil
}

func expandObjectUserRadiusVrfSelect(d *schema.ResourceData, v interface{}, pre string) (interface{}, error) {
	return v, nil
}
...
func getObjectObjectUserRadius(d *schema.ResourceData) (*map[string]interface{}, error) {
	...
	if v, ok := d.GetOk("fabric_force_sync"); ok || d.HasChange("fabric_force_sync") {
		t, err := expandObjectUserRadiusFabricForceSync(d, v, "fabric_force_sync")
		if err != nil {
			return &obj, err
		} else if t != nil {
	...
	if v, ok := d.GetOk("fabric_object"); ok || d.HasChange("fabric_object") {
		t, err := expandObjectUserRadiusFabricObject(d, v, "fabric_object")
		if err != nil {
			return &obj, err
		} else if t != nil {
			obj["fabric-object"] = t
	...
	if v, ok := d.GetOk("fabric_object_source"); ok || d.HasChange("fabric_object_source") {
		t, err := expandObjectUserRadiusFabricObjectSource(d, v, "fabric_object_source")
		if err != nil {
			return &obj, err
		} else if t != nil {
	...
	if v, ok := d.GetOk("require_message_authenticator"); ok || d.HasChange("require_message_authenticator") {
		t, err := expandObjectUserRadiusRequireMessageAuthenticator(d, v, "require_message_authenticator")
		if err != nil {
			return &obj, err
		} else if t != nil {
	...
	if v, ok := d.GetOk("uuid"); ok || d.HasChange("uuid") {
		t, err := expandObjectUserRadiusUuid(d, v, "uuid")
		if err != nil {
			return &obj, err
		} else if t != nil {
			obj["uuid"] = t
	...
	if v, ok := d.GetOk("vrf_select"); ok || d.HasChange("vrf_select") {
		t, err := expandObjectUserRadiusVrfSelect(d, v, "vrf_select")
		if err != nil {
			return &obj, err
		} else if t != nil {
			obj["vrf-select"] = t
