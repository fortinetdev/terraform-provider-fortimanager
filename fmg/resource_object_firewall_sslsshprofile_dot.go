...
func resourceObjectFirewallSslSshProfileDotUpdate(d *schema.ResourceData, m interface{}) error {
	...
	obj, err := getObjectObjectFirewallSslSshProfileDot(d, false)
	if err != nil {
	...
	_, err = c.UpdateObjectFirewallSslSshProfileDot(obj, mkey, paradict, wsParams)
	if err != nil {
...
func resourceObjectFirewallSslSshProfileDotDelete(d *schema.ResourceData, m interface{}) error {
	...
	obj, err := getObjectObjectFirewallSslSshProfileDot(d, true)
	...
	_, err = c.UpdateObjectFirewallSslSshProfileDot(obj, mkey, paradict, wsParams)
	if err != nil {
		return fmt.Errorf("Error clearing ObjectFirewallSslSshProfileDot resource: %v", err)
	}
...
func flattenObjectFirewallSslSshProfileDotUdpNotQuic2edl(v interface{}, d *schema.ResourceData, pre string) interface{} {
	return v
}
...
func refreshObjectObjectFirewallSslSshProfileDot(d *schema.ResourceData, o map[string]interface{}) error {
	...
	if err = d.Set("udp_not_quic", flattenObjectFirewallSslSshProfileDotUdpNotQuic2edl(o["udp-not-quic"], d, "udp_not_quic")); err != nil {
		if vv, ok := fortiAPIPatch(o["udp-not-quic"], "ObjectFirewallSslSshProfileDot-UdpNotQuic"); ok {
...
func expandObjectFirewallSslSshProfileDotUdpNotQuic2edl(d *schema.ResourceData, v interface{}, pre string) (interface{}, error) {
	return v, nil
}
...
func getObjectObjectFirewallSslSshProfileDot(d *schema.ResourceData, bemptysontable bool) (*map[string]interface{}, error) {
	...
	if v, ok := d.GetOk("udp_not_quic"); ok || d.HasChange("udp_not_quic") {
		t, err := expandObjectFirewallSslSshProfileDotUdpNotQuic2edl(d, v, "udp_not_quic")
		if err != nil {
			return &obj, err
		} else if t != nil {
			obj["udp-not-quic"] = t
