...
func resourceObjectSystemReplacemsgGroupDeviceDetectionPortalCreate(d *schema.ResourceData, m interface{}) error {
	...
	if update_if_exist && mkey_ok {
		...
		if err == nil && o != nil {
			existing = true
			// update if existing
			o, err = c.UpdateObjectSystemReplacemsgGroupDeviceDetectionPortal(obj, mkey, paradict, wsParams)
			if err != nil {
	...
	if !existing {
		_, err = c.CreateObjectSystemReplacemsgGroupDeviceDetectionPortal(obj, paradict, wsParams)
		if err != nil {
...
func resourceObjectSystemReplacemsgGroupDeviceDetectionPortalUpdate(d *schema.ResourceData, m interface{}) error {
	...
	_, err = c.UpdateObjectSystemReplacemsgGroupDeviceDetectionPortal(obj, mkey, paradict, wsParams)
	if err != nil {
		return fmt.Errorf("Error updating ObjectSystemReplacemsgGroupDeviceDetectionPortal resource: %v", err)
	}
...
func resourceObjectSystemReplacemsgGroupDeviceDetectionPortalDelete(d *schema.ResourceData, m interface{}) error {
	...
	err = c.DeleteObjectSystemReplacemsgGroupDeviceDetectionPortal(mkey, paradict, wsParams)
	if err != nil {
