...
func resourcePackagesFirewallResponseShapingPolicySort() *schema.Resource {
	return &schema.Resource{
		Create: resourcePackagesFirewallResponseShapingPolicySortCreateUpdate,
		Read:   resourcePackagesFirewallResponseShapingPolicySortRead,
		Update: resourcePackagesFirewallResponseShapingPolicySortCreateUpdate,
		Delete: schema.Noop,
...
func resourcePackagesFirewallResponseShapingPolicySortCreateUpdate(d *schema.ResourceData, m interface{}) (err error) {
	...
	err = c.CreateUpdatePackagesFirewallResponseShapingPolicySort(&input_model)
	if err != nil {
		return fmt.Errorf("Error sorting PackagesFirewallResponseShapingPolicy: %s", err)
	}

	d.SetId(sortby + sortdirection)

	return resourcePackagesFirewallResponseShapingPolicySortRead(d, m)
}

func resourcePackagesFirewallResponseShapingPolicySortRead(d *schema.ResourceData, m interface{}) error {
	mkey := d.Id()
	...
	sorted, o, err := c.ReadPackagesFirewallResponseShapingPolicySort(&input_model)
	if err != nil {
		return fmt.Errorf("Error reading PackagesFirewallResponseShapingPolicy sort status: %s %s", err, mkey)
	}
	...
	if o != nil {
		if err := d.Set("state_list", o); err != nil {
			log.Printf("[WARN] Error reading PackagesFirewallResponseShapingPolicy List for (%s): %s", d.Id(), err)
		}
	} else {
