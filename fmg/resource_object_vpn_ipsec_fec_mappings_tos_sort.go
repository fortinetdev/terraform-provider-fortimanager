...
func resourceObjectVpnIpsecFecMappingsTosSort() *schema.Resource {
	return &schema.Resource{
		Create: resourceObjectVpnIpsecFecMappingsTosSortCreateUpdate,
		Read:   resourceObjectVpnIpsecFecMappingsTosSortRead,
		Update: resourceObjectVpnIpsecFecMappingsTosSortCreateUpdate,
		Delete: schema.Noop,
...
func resourceObjectVpnIpsecFecMappingsTosSortCreateUpdate(d *schema.ResourceData, m interface{}) (err error) {
	...
	err = c.CreateUpdateObjectVpnIpsecFecMappingsTosSort(&input_model)
	if err != nil {
		return fmt.Errorf("Error sorting ObjectVpnIpsecFecMappingsTos: %s", err)
	}

	d.SetId(sortby + sortdirection)

	return resourceObjectVpnIpsecFecMappingsTosSortRead(d, m)
}

func resourceObjectVpnIpsecFecMappingsTosSortRead(d *schema.ResourceData, m interface{}) error {
	mkey := d.Id()
	...
	sorted, o, err := c.ReadObjectVpnIpsecFecMappingsTosSort(&input_model)
	if err != nil {
		return fmt.Errorf("Error reading ObjectVpnIpsecFecMappingsTos sort status: %s %s", err, mkey)
	}
	...
	if o != nil {
		if err := d.Set("state_list", o); err != nil {
			log.Printf("[WARN] Error reading ObjectVpnIpsecFecMappingsTos List for (%s): %s", d.Id(), err)
		}
	} else {
