...
func resourceWantempSystemVirtualWanLinkMembersCreate(d *schema.ResourceData, m interface{}) error {
	...
	if update_if_exist && mkey_ok {
		...
		if err == nil && o != nil {
			existing = true
			// update if existing
			o, err = c.UpdateWantempSystemVirtualWanLinkMembers(obj, mkey, paradict, wsParams)
			if err != nil {
	...
	if !existing {
		_, err = c.CreateWantempSystemVirtualWanLinkMembers(obj, paradict, wsParams)
		if err != nil {
...
func resourceWantempSystemVirtualWanLinkMembersUpdate(d *schema.ResourceData, m interface{}) error {
	...
	_, err = c.UpdateWantempSystemVirtualWanLinkMembers(obj, mkey, paradict, wsParams)
	if err != nil {
		return fmt.Errorf("Error updating WantempSystemVirtualWanLinkMembers resource: %v", err)
	}
...
func resourceWantempSystemVirtualWanLinkMembersDelete(d *schema.ResourceData, m interface{}) error {
	...
	err = c.DeleteWantempSystemVirtualWanLinkMembers(mkey, paradict, wsParams)
	if err != nil {
