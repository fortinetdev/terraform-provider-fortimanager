...
func refreshObjectObjectFirewallSshLocalCa(d *schema.ResourceData, o map[string]interface{}) error {
	...
	if err = d.Set("password", flattenObjectFirewallSshLocalCaPassword(o["password"], d, "password")); err != nil {
		if vv, ok := fortiAPIPatch(o["password"], "ObjectFirewallSshLocalCa-Password"); ok {
