...
func resourceWantempSystemVirtualWanLinkServiceSlaCreate(d *schema.ResourceData, m interface{}) error {
	...
	if update_if_exist && mkey_ok {
		...
		if err == nil && o != nil {
			existing = true
			// update if existing
			o, err = c.UpdateWantempSystemVirtualWanLinkServiceSla(obj, mkey, paradict, wsParams)
			if err != nil {
	...
	if !existing {
		_, err = c.CreateWantempSystemVirtualWanLinkServiceSla(obj, paradict, wsParams)
		if err != nil {
...
func resourceWantempSystemVirtualWanLinkServiceSlaUpdate(d *schema.ResourceData, m interface{}) error {
	...
	_, err = c.UpdateWantempSystemVirtualWanLinkServiceSla(obj, mkey, paradict, wsParams)
	if err != nil {
		return fmt.Errorf("Error updating WantempSystemVirtualWanLinkServiceSla resource: %v", err)
	}
...
func resourceWantempSystemVirtualWanLinkServiceSlaDelete(d *schema.ResourceData, m interface{}) error {
	...
	err = c.DeleteWantempSystemVirtualWanLinkServiceSla(mkey, paradict, wsParams)
	if err != nil {
