...
func resourceObjectSystemSdnConnectorExternalAccountListSort() *schema.Resource {
	return &schema.Resource{
		Create: resourceObjectSystemSdnConnectorExternalAccountListSortCreateUpdate,
		Read:   resourceObjectSystemSdnConnectorExternalAccountListSortRead,
		Update: resourceObjectSystemSdnConnectorExternalAccountListSortCreateUpdate,
		Delete: schema.Noop,
...
func resourceObjectSystemSdnConnectorExternalAccountListSortCreateUpdate(d *schema.ResourceData, m interface{}) (err error) {
	...
	err = c.CreateUpdateObjectSystemSdnConnectorExternalAccountListSort(&input_model)
	if err != nil {
		return fmt.Errorf("Error sorting ObjectSystemSdnConnectorExternalAccountList: %s", err)
	}

	d.SetId(sortby + sortdirection)

	return resourceObjectSystemSdnConnectorExternalAccountListSortRead(d, m)
}

func resourceObjectSystemSdnConnectorExternalAccountListSortRead(d *schema.ResourceData, m interface{}) error {
	mkey := d.Id()
	...
	sorted, o, err := c.ReadObjectSystemSdnConnectorExternalAccountListSort(&input_model)
	if err != nil {
		return fmt.Errorf("Error reading ObjectSystemSdnConnectorExternalAccountList sort status: %s %s", err, mkey)
	}
	...
	if o != nil {
		if err := d.Set("state_list", o); err != nil {
			log.Printf("[WARN] Error reading ObjectSystemSdnConnectorExternalAccountList List for (%s): %s", d.Id(), err)
		}
	} else {
