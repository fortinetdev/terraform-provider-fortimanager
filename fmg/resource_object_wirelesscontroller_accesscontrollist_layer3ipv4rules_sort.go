...
func resourceObjectWirelessControllerAccessControlListLayer3Ipv4RulesSort() *schema.Resource {
	return &schema.Resource{
		Create: resourceObjectWirelessControllerAccessControlListLayer3Ipv4RulesSortCreateUpdate,
		Read:   resourceObjectWirelessControllerAccessControlListLayer3Ipv4RulesSortRead,
		Update: resourceObjectWirelessControllerAccessControlListLayer3Ipv4RulesSortCreateUpdate,
		Delete: schema.Noop,
...
func resourceObjectWirelessControllerAccessControlListLayer3Ipv4RulesSortCreateUpdate(d *schema.ResourceData, m interface{}) (err error) {
	...
	err = c.CreateUpdateObjectWirelessControllerAccessControlListLayer3Ipv4RulesSort(&input_model)
	if err != nil {
		return fmt.Errorf("Error sorting ObjectWirelessControllerAccessControlListLayer3Ipv4Rules: %s", err)
	}

	d.SetId(sortby + sortdirection)

	return resourceObjectWirelessControllerAccessControlListLayer3Ipv4RulesSortRead(d, m)
}

func resourceObjectWirelessControllerAccessControlListLayer3Ipv4RulesSortRead(d *schema.ResourceData, m interface{}) error {
	mkey := d.Id()
	...
	sorted, o, err := c.ReadObjectWirelessControllerAccessControlListLayer3Ipv4RulesSort(&input_model)
	if err != nil {
		return fmt.Errorf("Error reading ObjectWirelessControllerAccessControlListLayer3Ipv4Rules sort status: %s %s", err, mkey)
	}
	...
	if o != nil {
		if err := d.Set("state_list", o); err != nil {
			log.Printf("[WARN] Error reading ObjectWirelessControllerAccessControlListLayer3Ipv4Rules List for (%s): %s", d.Id(), err)
		}
	} else {
