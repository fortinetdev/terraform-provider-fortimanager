...
func resourcePackagesFirewallProxyPolicySort() *schema.Resource {
	return &schema.Resource{
		Create: resourcePackagesFirewallProxyPolicySortCreateUpdate,
		Read:   resourcePackagesFirewallProxyPolicySortRead,
		Update: resourcePackagesFirewallProxyPolicySortCreateUpdate,
		Delete: schema.Noop,
...
func resourcePackagesFirewallProxyPolicySortCreateUpdate(d *schema.ResourceData, m interface{}) (err error) {
	...
	err = c.CreateUpdatePackagesFirewallProxyPolicySort(&input_model)
	if err != nil {
		return fmt.Errorf("Error sorting PackagesFirewallProxyPolicy: %s", err)
	}

	d.SetId(sortby + sortdirection)

	return resourcePackagesFirewallProxyPolicySortRead(d, m)
}

func resourcePackagesFirewallProxyPolicySortRead(d *schema.ResourceData, m interface{}) error {
	mkey := d.Id()
	...
	sorted, o, err := c.ReadPackagesFirewallProxyPolicySort(&input_model)
	if err != nil {
		return fmt.Errorf("Error reading PackagesFirewallProxyPolicy sort status: %s %s", err, mkey)
	}
	...
	if o != nil {
		if err := d.Set("state_list", o); err != nil {
			log.Printf("[WARN] Error reading PackagesFirewallProxyPolicy List for (%s): %s", d.Id(), err)
		}
	} else {
