...
func resourcePackagesFirewallDosPolicySort() *schema.Resource {
	return &schema.Resource{
		Create: resourcePackagesFirewallDosPolicySortCreateUpdate,
		Read:   resourcePackagesFirewallDosPolicySortRead,
		Update: resourcePackagesFirewallDosPolicySortCreateUpdate,
		Delete: schema.Noop,
...
func resourcePackagesFirewallDosPolicySortCreateUpdate(d *schema.ResourceData, m interface{}) (err error) {
	...
	err = c.CreateUpdatePackagesFirewallDosPolicySort(&input_model)
	if err != nil {
		return fmt.Errorf("Error sorting PackagesFirewallDosPolicy: %s", err)
	}

	d.SetId(sortby + sortdirection)

	return resourcePackagesFirewallDosPolicySortRead(d, m)
}

func resourcePackagesFirewallDosPolicySortRead(d *schema.ResourceData, m interface{}) error {
	mkey := d.Id()
	...
	sorted, o, err := c.ReadPackagesFirewallDosPolicySort(&input_model)
	if err != nil {
		return fmt.Errorf("Error reading PackagesFirewallDosPolicy sort status: %s %s", err, mkey)
	}
	...
	if o != nil {
		if err := d.Set("state_list", o); err != nil {
			log.Printf("[WARN] Error reading PackagesFirewallDosPolicy List for (%s): %s", d.Id(), err)
		}
	} else {
