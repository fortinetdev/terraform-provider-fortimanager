...
func resourcePackagesFirewallProxyPolicyMoveUpdate(d *schema.ResourceData, m interface{}) error {
	...
	_, err = c.UpdatePackagesFirewallProxyPolicyMove(obj, mkey, paradict, wsParams)
	if err != nil {
	...
	d.SetId("PackagesFirewallProxyPolicyMove" + "_" + pkg_folder_path + "_" + pkg + "_" + proxy_policy + "_" + target)
