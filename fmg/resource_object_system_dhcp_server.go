...
func resourceObjectSystemDhcpServerCreate(d *schema.ResourceData, m interface{}) error {
	...
	if update_if_exist && mkey_ok {
		// check existing
		o, err = c.ReadObjectSystemDhcpServer(mkey, paradict)
		if err == nil && o != nil {
			existing = true
			// update if existing
			o, err = c.UpdateObjectSystemDhcpServer(obj, mkey, paradict, wsParams)
			if err != nil {
...
func flattenObjectSystemDhcpServerExcludeRange(v interface{}, d *schema.ResourceData, pre string) []map[string]interface{} {
	...
	for _, r := range l {
		...
		if _, ok := i["lease-time"]; ok {
			v := flattenObjectSystemDhcpServerExcludeRangeLeaseTime(i["lease-time"], d, pre_append)
			tmp["lease_time"] = fortiAPISubPartPatch(v, "ObjectSystemDhcpServer-ExcludeRange-LeaseTime")
		}

		pre_append = pre + "." + strconv.Itoa(con) + "." + "oui_match"
		if _, ok := i["oui-match"]; ok {
			v := flattenObjectSystemDhcpServerExcludeRangeOuiMatch(i["oui-match"], d, pre_append)
			tmp["oui_match"] = fortiAPISubPartPatch(v, "ObjectSystemDhcpServer-ExcludeRange-OuiMatch")
		}

		pre_append = pre + "." + strconv.Itoa(con) + "." + "oui_string"
		if _, ok := i["oui-string"]; ok {
			v := flattenObjectSystemDhcpServerExcludeRangeOuiString(i["oui-string"], d, pre_append)
			tmp["oui_string"] = fortiAPISubPartPatch(v, "ObjectSystemDhcpServer-ExcludeRange-OuiString")
		}
		...
		if _, ok := i["uci-match"]; ok {
			v := flattenObjectSystemDhcpServerExcludeRangeUciMatch(i["uci-match"], d, pre_append)
			tmp["uci_match"] = fortiAPISubPartPatch(v, "ObjectSystemDhcpServer-ExcludeRange-UciMatch")
		}

		pre_append = pre + "." + strconv.Itoa(con) + "." + "uci_string"
		if _, ok := i["uci-string"]; ok {
			v := flattenObjectSystemDhcpServerExcludeRangeUciString(i["uci-string"], d, pre_append)
			tmp["uci_string"] = fortiAPISubPartPatch(v, "ObjectSystemDhcpServer-ExcludeRange-UciString")
		}

		pre_append = pre + "." + strconv.Itoa(con) + "." + "vci_match"
		if _, ok := i["vci-match"]; ok {
			v := flattenObjectSystemDhcpServerExcludeRangeVciMatch(i["vci-match"], d, pre_append)
			tmp["vci_match"] = fortiAPISubPartPatch(v, "ObjectSystemDhcpServer-ExcludeRange-VciMatch")
		}

		pre_append = pre + "." + strconv.Itoa(con) + "." + "vci_string"
		if _, ok := i["vci-string"]; ok {
			v := flattenObjectSystemDhcpServerExcludeRangeVciString(i["vci-string"], d, pre_append)
		...
		if _, ok := i["vendor"]; ok {
			v := flattenObjectSystemDhcpServerExcludeRangeVendor(i["vendor"], d, pre_append)
			tmp["vendor"] = fortiAPISubPartPatch(v, "ObjectSystemDhcpServer-ExcludeRange-Vendor")
		}
...
func flattenObjectSystemDhcpServerExcludeRangeLeaseTime(v interface{}, d *schema.ResourceData, pre string) interface{} {
	return v
}

func flattenObjectSystemDhcpServerExcludeRangeOuiMatch(v interface{}, d *schema.ResourceData, pre string) interface{} {
	return v
}

func flattenObjectSystemDhcpServerExcludeRangeOuiString(v interface{}, d *schema.ResourceData, pre string) interface{} {
...
func flattenObjectSystemDhcpServerExcludeRangeUciMatch(v interface{}, d *schema.ResourceData, pre string) interface{} {
	return v
}

func flattenObjectSystemDhcpServerExcludeRangeUciString(v interface{}, d *schema.ResourceData, pre string) interface{} {
	return flattenStringList(v)
}

func flattenObjectSystemDhcpServerExcludeRangeVciMatch(v interface{}, d *schema.ResourceData, pre string) interface{} {
	return v
}

func flattenObjectSystemDhcpServerExcludeRangeVciString(v interface{}, d *schema.ResourceData, pre string) interface{} {
	return flattenStringList(v)
}

func flattenObjectSystemDhcpServerExcludeRangeVendor(v interface{}, d *schema.ResourceData, pre string) interface{} {
	return v
}
...
func flattenObjectSystemDhcpServerIpRange(v interface{}, d *schema.ResourceData, pre string) []map[string]interface{} {
	...
	for _, r := range l {
		...
		pre_append = pre + "." + strconv.Itoa(con) + "." + "lease_time"
		if _, ok := i["lease-time"]; ok {
			v := flattenObjectSystemDhcpServerIpRangeLeaseTime(i["lease-time"], d, pre_append)
			tmp["lease_time"] = fortiAPISubPartPatch(v, "ObjectSystemDhcpServer-IpRange-LeaseTime")
		}

		pre_append = pre + "." + strconv.Itoa(con) + "." + "oui_match"
		if _, ok := i["oui-match"]; ok {
			v := flattenObjectSystemDhcpServerIpRangeOuiMatch(i["oui-match"], d, pre_append)
			tmp["oui_match"] = fortiAPISubPartPatch(v, "ObjectSystemDhcpServer-IpRange-OuiMatch")
		}

		pre_append = pre + "." + strconv.Itoa(con) + "." + "oui_string"
		if _, ok := i["oui-string"]; ok {
			v := flattenObjectSystemDhcpServerIpRangeOuiString(i["oui-string"], d, pre_append)
			tmp["oui_string"] = fortiAPISubPartPatch(v, "ObjectSystemDhcpServer-IpRange-OuiString")
		}
		...
		pre_append = pre + "." + strconv.Itoa(con) + "." + "uci_match"
		if _, ok := i["uci-match"]; ok {
			v := flattenObjectSystemDhcpServerIpRangeUciMatch(i["uci-match"], d, pre_append)
			tmp["uci_match"] = fortiAPISubPartPatch(v, "ObjectSystemDhcpServer-IpRange-UciMatch")
		}

		pre_append = pre + "." + strconv.Itoa(con) + "." + "uci_string"
		if _, ok := i["uci-string"]; ok {
			v := flattenObjectSystemDhcpServerIpRangeUciString(i["uci-string"], d, pre_append)
			tmp["uci_string"] = fortiAPISubPartPatch(v, "ObjectSystemDhcpServer-IpRange-UciString")
		}

		pre_append = pre + "." + strconv.Itoa(con) + "." + "vci_match"
		if _, ok := i["vci-match"]; ok {
			v := flattenObjectSystemDhcpServerIpRangeVciMatch(i["vci-match"], d, pre_append)
			tmp["vci_match"] = fortiAPISubPartPatch(v, "ObjectSystemDhcpServer-IpRange-VciMatch")
		}

		pre_append = pre + "." + strconv.Itoa(con) + "." + "vci_string"
		if _, ok := i["vci-string"]; ok {
			v := flattenObjectSystemDhcpServerIpRangeVciString(i["vci-string"], d, pre_append)
			tmp["vci_string"] = fortiAPISubPartPatch(v, "ObjectSystemDhcpServer-IpRange-VciString")
		}

		pre_append = pre + "." + strconv.Itoa(con) + "." + "vendor"
		if _, ok := i["vendor"]; ok {
			v := flattenObjectSystemDhcpServerIpRangeVendor(i["vendor"], d, pre_append)
			tmp["vendor"] = fortiAPISubPartPatch(v, "ObjectSystemDhcpServer-IpRange-Vendor")
		}
...
func flattenObjectSystemDhcpServerIpRangeLeaseTime(v interface{}, d *schema.ResourceData, pre string) interface{} {
	return v
}

func flattenObjectSystemDhcpServerIpRangeOuiMatch(v interface{}, d *schema.ResourceData, pre string) interface{} {
	return v
}

func flattenObjectSystemDhcpServerIpRangeOuiString(v interface{}, d *schema.ResourceData, pre string) interface{} {
	return flattenStringList(v)
}
...
func flattenObjectSystemDhcpServerIpRangeUciMatch(v interface{}, d *schema.ResourceData, pre string) interface{} {
	return v
}

func flattenObjectSystemDhcpServerIpRangeUciString(v interface{}, d *schema.ResourceData, pre string) interface{} {
	return flattenStringList(v)
}

func flattenObjectSystemDhcpServerIpRangeVciMatch(v interface{}, d *schema.ResourceData, pre string) interface{} {
	return v
}

func flattenObjectSystemDhcpServerIpRangeVciString(v interface{}, d *schema.ResourceData, pre string) interface{} {
	return flattenStringList(v)
}

func flattenObjectSystemDhcpServerIpRangeVendor(v interface{}, d *schema.ResourceData, pre string) interface{} {
	return v
}
...
func flattenObjectSystemDhcpServerOptions(v interface{}, d *schema.ResourceData, pre string) []map[string]interface{} {
	...
	for _, r := range l {
		...
		pre_append = pre + "." + strconv.Itoa(con) + "." + "uci_match"
		if _, ok := i["uci-match"]; ok {
			v := flattenObjectSystemDhcpServerOptionsUciMatch(i["uci-match"], d, pre_append)
			tmp["uci_match"] = fortiAPISubPartPatch(v, "ObjectSystemDhcpServer-Options-UciMatch")
		}

		pre_append = pre + "." + strconv.Itoa(con) + "." + "uci_string"
		if _, ok := i["uci-string"]; ok {
			v := flattenObjectSystemDhcpServerOptionsUciString(i["uci-string"], d, pre_append)
			tmp["uci_string"] = fortiAPISubPartPatch(v, "ObjectSystemDhcpServer-Options-UciString")
		}
		...
		pre_append = pre + "." + strconv.Itoa(con) + "." + "vci_match"
		if _, ok := i["vci-match"]; ok {
			v := flattenObjectSystemDhcpServerOptionsVciMatch(i["vci-match"], d, pre_append)
			tmp["vci_match"] = fortiAPISubPartPatch(v, "ObjectSystemDhcpServer-Options-VciMatch")
		}

		pre_append = pre + "." + strconv.Itoa(con) + "." + "vci_string"
		if _, ok := i["vci-string"]; ok {
			v := flattenObjectSystemDhcpServerOptionsVciString(i["vci-string"], d, pre_append)
...
func flattenObjectSystemDhcpServerOptionsUciMatch(v interface{}, d *schema.ResourceData, pre string) interface{} {
	return v
}

func flattenObjectSystemDhcpServerOptionsUciString(v interface{}, d *schema.ResourceData, pre string) interface{} {
	return flattenStringList(v)
}
...
func flattenObjectSystemDhcpServerOptionsVciMatch(v interface{}, d *schema.ResourceData, pre string) interface{} {
	return v
}

func flattenObjectSystemDhcpServerOptionsVciString(v interface{}, d *schema.ResourceData, pre string) interface{} {
	return flattenStringList(v)
}

func flattenObjectSystemDhcpServerRelayAgent(v interface{}, d *schema.ResourceData, pre string) interface{} {
	return v
}
...
func flattenObjectSystemDhcpServerSharedSubnet(v interface{}, d *schema.ResourceData, pre string) interface{} {
	return v
}
...
func flattenObjectSystemDhcpServerTemplate(v interface{}, d *schema.ResourceData, pre string) interface{} {
	return flattenStringList(v)
}

func flattenObjectSystemDhcpServerTemplateSubnet(v interface{}, d *schema.ResourceData, pre string) interface{} {
	return flattenStringList(v)
}

func flattenObjectSystemDhcpServerTemplateSubnetFromInterface(v interface{}, d *schema.ResourceData, pre string) interface{} {
	return v
}
...
func refreshObjectObjectSystemDhcpServer(d *schema.ResourceData, o map[string]interface{}) error {
	...
	if err = d.Set("relay_agent", flattenObjectSystemDhcpServerRelayAgent(o["relay-agent"], d, "relay_agent")); err != nil {
		if vv, ok := fortiAPIPatch(o["relay-agent"], "ObjectSystemDhcpServer-RelayAgent"); ok {
	...
	if err = d.Set("shared_subnet", flattenObjectSystemDhcpServerSharedSubnet(o["shared-subnet"], d, "shared_subnet")); err != nil {
		if vv, ok := fortiAPIPatch(o["shared-subnet"], "ObjectSystemDhcpServer-SharedSubnet"); ok {
	...
	if err = d.Set("template", flattenObjectSystemDhcpServerTemplate(o["template"], d, "template")); err != nil {
		if vv, ok := fortiAPIPatch(o["template"], "ObjectSystemDhcpServer-Template"); ok {
	...
	if err = d.Set("template_subnet", flattenObjectSystemDhcpServerTemplateSubnet(o["template-subnet"], d, "template_subnet")); err != nil {
		if vv, ok := fortiAPIPatch(o["template-subnet"], "ObjectSystemDhcpServer-TemplateSubnet"); ok {
	...
	if err = d.Set("template_subnet_from_interface", flattenObjectSystemDhcpServerTemplateSubnetFromInterface(o["template-subnet-from-interface"], d, "template_subnet_from_interface")); err != nil {
		if vv, ok := fortiAPIPatch(o["template-subnet-from-interface"], "ObjectSystemDhcpServer-TemplateSubnetFromInterface"); ok {
...
func expandObjectSystemDhcpServerExcludeRange(d *schema.ResourceData, v interface{}, pre string) (interface{}, error) {
	...
	for _, r := range l {
		...
		pre_append = pre + "." + strconv.Itoa(con) + "." + "lease_time"
		if _, ok := d.GetOk(pre_append); ok || d.HasChange(pre_append) {
			tmp["lease-time"], _ = expandObjectSystemDhcpServerExcludeRangeLeaseTime(d, i["lease_time"], pre_append)
		}

		pre_append = pre + "." + strconv.Itoa(con) + "." + "oui_match"
		if _, ok := d.GetOk(pre_append); ok || d.HasChange(pre_append) {
			tmp["oui-match"], _ = expandObjectSystemDhcpServerExcludeRangeOuiMatch(d, i["oui_match"], pre_append)
		}

		pre_append = pre + "." + strconv.Itoa(con) + "." + "oui_string"
		if _, ok := d.GetOk(pre_append); ok || d.HasChange(pre_append) {
			tmp["oui-string"], _ = expandObjectSystemDhcpServerExcludeRangeOuiString(d, i["oui_string"], pre_append)
		}
		...
		pre_append = pre + "." + strconv.Itoa(con) + "." + "uci_match"
		if _, ok := d.GetOk(pre_append); ok || d.HasChange(pre_append) {
			tmp["uci-match"], _ = expandObjectSystemDhcpServerExcludeRangeUciMatch(d, i["uci_match"], pre_append)
		}

		pre_append = pre + "." + strconv.Itoa(con) + "." + "uci_string"
		if _, ok := d.GetOk(pre_append); ok || d.HasChange(pre_append) {
			tmp["uci-string"], _ = expandObjectSystemDhcpServerExcludeRangeUciString(d, i["uci_string"], pre_append)
		}

		pre_append = pre + "." + strconv.Itoa(con) + "." + "vci_match"
		if _, ok := d.GetOk(pre_append); ok || d.HasChange(pre_append) {
			tmp["vci-match"], _ = expandObjectSystemDhcpServerExcludeRangeVciMatch(d, i["vci_match"], pre_append)
		}
		...
		pre_append = pre + "." + strconv.Itoa(con) + "." + "vendor"
		if _, ok := d.GetOk(pre_append); ok || d.HasChange(pre_append) {
			tmp["vendor"], _ = expandObjectSystemDhcpServerExcludeRangeVendor(d, i["vendor"], pre_append)
		}
...
func expandObjectSystemDhcpServerExcludeRangeLeaseTime(d *schema.ResourceData, v interface{}, pre string) (interface{}, error) {
	return v, nil
}

func expandObjectSystemDhcpServerExcludeRangeOuiMatch(d *schema.ResourceData, v interface{}, pre string) (interface{}, error) {
	return v, nil
}

func expandObjectSystemDhcpServerExcludeRangeOuiString(d *schema.ResourceData, v interface{}, pre string) (interface{}, error) {
...
func expandObjectSystemDhcpServerExcludeRangeUciMatch(d *schema.ResourceData, v interface{}, pre string) (interface{}, error) {
	return v, nil
}

func expandObjectSystemDhcpServerExcludeRangeUciString(d *schema.ResourceData, v interface{}, pre string) (interface{}, error) {
	return expandStringList(v.(*schema.Set).List()), nil
}

func expandObjectSystemDhcpServerExcludeRangeVciMatch(d *schema.ResourceData, v interface{}, pre string) (interface{}, error) {
	return v, nil
}

func expandObjectSystemDhcpServerExcludeRangeVciString(d *schema.ResourceData, v interface{}, pre string) (interface{}, error) {
	return expandStringList(v.(*schema.Set).List()), nil
}

func expandObjectSystemDhcpServerExcludeRangeVendor(d *schema.ResourceData, v interface{}, pre string) (interface{}, error) {
	return v, nil
}
...
func expandObjectSystemDhcpServerIpRange(d *schema.ResourceData, v interface{}, pre string) (interface{}, error) {
	...
	for _, r := range l {
		...
		pre_append = pre + "." + strconv.Itoa(con) + "." + "lease_time"
		if _, ok := d.GetOk(pre_append); ok || d.HasChange(pre_append) {
			tmp["lease-time"], _ = expandObjectSystemDhcpServerIpRangeLeaseTime(d, i["lease_time"], pre_append)
		}

		pre_append = pre + "." + strconv.Itoa(con) + "." + "oui_match"
		if _, ok := d.GetOk(pre_append); ok || d.HasChange(pre_append) {
			tmp["oui-match"], _ = expandObjectSystemDhcpServerIpRangeOuiMatch(d, i["oui_match"], pre_append)
		}

		pre_append = pre + "." + strconv.Itoa(con) + "." + "oui_string"
		if _, ok := d.GetOk(pre_append); ok || d.HasChange(pre_append) {
			tmp["oui-string"], _ = expandObjectSystemDhcpServerIpRangeOuiString(d, i["oui_string"], pre_append)
		}
		...
		pre_append = pre + "." + strconv.Itoa(con) + "." + "uci_match"
		if _, ok := d.GetOk(pre_append); ok || d.HasChange(pre_append) {
			tmp["uci-match"], _ = expandObjectSystemDhcpServerIpRangeUciMatch(d, i["uci_match"], pre_append)
		}

		pre_append = pre + "." + strconv.Itoa(con) + "." + "uci_string"
		if _, ok := d.GetOk(pre_append); ok || d.HasChange(pre_append) {
			tmp["uci-string"], _ = expandObjectSystemDhcpServerIpRangeUciString(d, i["uci_string"], pre_append)
		}

		pre_append = pre + "." + strconv.Itoa(con) + "." + "vci_match"
		if _, ok := d.GetOk(pre_append); ok || d.HasChange(pre_append) {
			tmp["vci-match"], _ = expandObjectSystemDhcpServerIpRangeVciMatch(d, i["vci_match"], pre_append)
		}
		...
		pre_append = pre + "." + strconv.Itoa(con) + "." + "vendor"
		if _, ok := d.GetOk(pre_append); ok || d.HasChange(pre_append) {
			tmp["vendor"], _ = expandObjectSystemDhcpServerIpRangeVendor(d, i["vendor"], pre_append)
		}
...
func expandObjectSystemDhcpServerIpRangeLeaseTime(d *schema.ResourceData, v interface{}, pre string) (interface{}, error) {
	return v, nil
}

func expandObjectSystemDhcpServerIpRangeOuiMatch(d *schema.ResourceData, v interface{}, pre string) (interface{}, error) {
	return v, nil
}

func expandObjectSystemDhcpServerIpRangeOuiString(d *schema.ResourceData, v interface{}, pre string) (interface{}, error) {
	return expandStringList(v.(*schema.Set).List()), nil
}
...
func expandObjectSystemDhcpServerIpRangeUciMatch(d *schema.ResourceData, v interface{}, pre string) (interface{}, error) {
	return v, nil
}

func expandObjectSystemDhcpServerIpRangeUciString(d *schema.ResourceData, v interface{}, pre string) (interface{}, error) {
	return expandStringList(v.(*schema.Set).List()), nil
}

func expandObjectSystemDhcpServerIpRangeVciMatch(d *schema.ResourceData, v interface{}, pre string) (interface{}, error) {
	return v, nil
}

func expandObjectSystemDhcpServerIpRangeVciString(d *schema.ResourceData, v interface{}, pre string) (interface{}, error) {
	return expandStringList(v.(*schema.Set).List()), nil
}

func expandObjectSystemDhcpServerIpRangeVendor(d *schema.ResourceData, v interface{}, pre string) (interface{}, error) {
	return v, nil
}
...
func expandObjectSystemDhcpServerOptions(d *schema.ResourceData, v interface{}, pre string) (interface{}, error) {
	...
	for _, r := range l {
		...
		pre_append = pre + "." + strconv.Itoa(con) + "." + "uci_match"
		if _, ok := d.GetOk(pre_append); ok || d.HasChange(pre_append) {
			tmp["uci-match"], _ = expandObjectSystemDhcpServerOptionsUciMatch(d, i["uci_match"], pre_append)
		}

		pre_append = pre + "." + strconv.Itoa(con) + "." + "uci_string"
		if _, ok := d.GetOk(pre_append); ok || d.HasChange(pre_append) {
			tmp["uci-string"], _ = expandObjectSystemDhcpServerOptionsUciString(d, i["uci_string"], pre_append)
		}
		...
		pre_append = pre + "." + strconv.Itoa(con) + "." + "vci_match"
		if _, ok := d.GetOk(pre_append); ok || d.HasChange(pre_append) {
			tmp["vci-match"], _ = expandObjectSystemDhcpServerOptionsVciMatch(d, i["vci_match"], pre_append)
		}
...
func expandObjectSystemDhcpServerOptionsUciMatch(d *schema.ResourceData, v interface{}, pre string) (interface{}, error) {
	return v, nil
}

func expandObjectSystemDhcpServerOptionsUciString(d *schema.ResourceData, v interface{}, pre string) (interface{}, error) {
	return expandStringList(v.(*schema.Set).List()), nil
}
...
func expandObjectSystemDhcpServerOptionsVciMatch(d *schema.ResourceData, v interface{}, pre string) (interface{}, error) {
	return v, nil
}

func expandObjectSystemDhcpServerOptionsVciString(d *schema.ResourceData, v interface{}, pre string) (interface{}, error) {
	return expandStringList(v.(*schema.Set).List()), nil
}

func expandObjectSystemDhcpServerRelayAgent(d *schema.ResourceData, v interface{}, pre string) (interface{}, error) {
	return v, nil
}
...
func expandObjectSystemDhcpServerSharedSubnet(d *schema.ResourceData, v interface{}, pre string) (interface{}, error) {
	return v, nil
}
...
func expandObjectSystemDhcpServerTemplate(d *schema.ResourceData, v interface{}, pre string) (interface{}, error) {
	return expandStringList(v.(*schema.Set).List()), nil
}

func expandObjectSystemDhcpServerTemplateSubnet(d *schema.ResourceData, v interface{}, pre string) (interface{}, error) {
	return expandStringList(v.([]interface{})), nil
}

func expandObjectSystemDhcpServerTemplateSubnetFromInterface(d *schema.ResourceData, v interface{}, pre string) (interface{}, error) {
	return v, nil
}
...
func getObjectObjectSystemDhcpServer(d *schema.ResourceData) (*map[string]interface{}, error) {
	...
	if v, ok := d.GetOk("relay_agent"); ok || d.HasChange("relay_agent") {
		t, err := expandObjectSystemDhcpServerRelayAgent(d, v, "relay_agent")
		if err != nil {
			return &obj, err
		} else if t != nil {
			obj["relay-agent"] = t
	...
	if v, ok := d.GetOk("shared_subnet"); ok || d.HasChange("shared_subnet") {
		t, err := expandObjectSystemDhcpServerSharedSubnet(d, v, "shared_subnet")
		if err != nil {
			return &obj, err
		} else if t != nil {
			obj["shared-subnet"] = t
	...
	if v, ok := d.GetOk("template"); ok || d.HasChange("template") {
		t, err := expandObjectSystemDhcpServerTemplate(d, v, "template")
		if err != nil {
			return &obj, err
		} else if t != nil {
			obj["template"] = t
	...
	if v, ok := d.GetOk("template_subnet"); ok || d.HasChange("template_subnet") {
		t, err := expandObjectSystemDhcpServerTemplateSubnet(d, v, "template_subnet")
		if err != nil {
			return &obj, err
		} else if t != nil {
	...
	if v, ok := d.GetOk("template_subnet_from_interface"); ok || d.HasChange("template_subnet_from_interface") {
		t, err := expandObjectSystemDhcpServerTemplateSubnetFromInterface(d, v, "template_subnet_from_interface")
		if err != nil {
			return &obj, err
		} else if t != nil {
