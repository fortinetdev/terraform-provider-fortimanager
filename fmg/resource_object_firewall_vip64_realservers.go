...
func resourceObjectFirewallVip64RealserversCreate(d *schema.ResourceData, m interface{}) error {
	...
	if update_if_exist && mkey_ok {
		...
		if err == nil && o != nil {
			existing = true
			// update if existing
			o, err = c.UpdateObjectFirewallVip64Realservers(obj, mkey, paradict, wsParams)
			if err != nil {
	...
	if !existing {
		_, err = c.CreateObjectFirewallVip64Realservers(obj, paradict, wsParams)
		if err != nil {
...
func resourceObjectFirewallVip64RealserversUpdate(d *schema.ResourceData, m interface{}) error {
	...
	_, err = c.UpdateObjectFirewallVip64Realservers(obj, mkey, paradict, wsParams)
	if err != nil {
		return fmt.Errorf("Error updating ObjectFirewallVip64Realservers resource: %v", err)
	}
...
func resourceObjectFirewallVip64RealserversDelete(d *schema.ResourceData, m interface{}) error {
	...
	err = c.DeleteObjectFirewallVip64Realservers(mkey, paradict, wsParams)
	if err != nil {
