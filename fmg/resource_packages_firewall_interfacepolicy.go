...
func resourcePackagesFirewallInterfacePolicyCreate(d *schema.ResourceData, m interface{}) error {
	...
	if update_if_exist && mkey_ok {
		// check existing
		o, err = c.ReadPackagesFirewallInterfacePolicy(mkey, paradict)
		if err == nil && o != nil {
			existing = true
			// update if existing
			o, err = c.UpdatePackagesFirewallInterfacePolicy(obj, mkey, paradict, wsParams)
			if err != nil {
	...
	if !existing {
		v, err := c.CreatePackagesFirewallInterfacePolicy(obj, paradict, wsParams)
		if err != nil {
...
func resourcePackagesFirewallInterfacePolicyUpdate(d *schema.ResourceData, m interface{}) error {
	...
	v, err := c.UpdatePackagesFirewallInterfacePolicy(obj, mkey, paradict, wsParams)
	if err != nil {
		return fmt.Errorf("Error updating PackagesFirewallInterfacePolicy resource: %v", err)
	}
...
func resourcePackagesFirewallInterfacePolicyDelete(d *schema.ResourceData, m interface{}) error {
	...
	err = c.DeletePackagesFirewallInterfacePolicy(mkey, paradict, wsParams)
	if err != nil {
...
func flattenPackagesFirewallInterfacePolicyCasbProfile(v interface{}, d *schema.ResourceData, pre string) interface{} {
	return flattenStringList(v)
}

func flattenPackagesFirewallInterfacePolicyCasbProfileStatus(v interface{}, d *schema.ResourceData, pre string) interface{} {
	return v
}
...
func flattenPackagesFirewallInterfacePolicyDlpProfile(v interface{}, d *schema.ResourceData, pre string) interface{} {
	return convintflist2str(v, d.Get(pre))
}

func flattenPackagesFirewallInterfacePolicyDlpProfileStatus(v interface{}, d *schema.ResourceData, pre string) interface{} {
	return v
}
...
func refreshObjectPackagesFirewallInterfacePolicy(d *schema.ResourceData, o map[string]interface{}) error {
	...
	if err = d.Set("casb_profile", flattenPackagesFirewallInterfacePolicyCasbProfile(o["casb-profile"], d, "casb_profile")); err != nil {
		if vv, ok := fortiAPIPatch(o["casb-profile"], "PackagesFirewallInterfacePolicy-CasbProfile"); ok {
	...
	if err = d.Set("casb_profile_status", flattenPackagesFirewallInterfacePolicyCasbProfileStatus(o["casb-profile-status"], d, "casb_profile_status")); err != nil {
		if vv, ok := fortiAPIPatch(o["casb-profile-status"], "PackagesFirewallInterfacePolicy-CasbProfileStatus"); ok {
	...
	if err = d.Set("dlp_profile", flattenPackagesFirewallInterfacePolicyDlpProfile(o["dlp-profile"], d, "dlp_profile")); err != nil {
		if vv, ok := fortiAPIPatch(o["dlp-profile"], "PackagesFirewallInterfacePolicy-DlpProfile"); ok {
	...
	if err = d.Set("dlp_profile_status", flattenPackagesFirewallInterfacePolicyDlpProfileStatus(o["dlp-profile-status"], d, "dlp_profile_status")); err != nil {
		if vv, ok := fortiAPIPatch(o["dlp-profile-status"], "PackagesFirewallInterfacePolicy-DlpProfileStatus"); ok {
...
func expandPackagesFirewallInterfacePolicyCasbProfile(d *schema.ResourceData, v interface{}, pre string) (interface{}, error) {
	return expandStringList(v.(*schema.Set).List()), nil
}

func expandPackagesFirewallInterfacePolicyCasbProfileStatus(d *schema.ResourceData, v interface{}, pre string) (interface{}, error) {
	return v, nil
}
...
func expandPackagesFirewallInterfacePolicyDlpProfile(d *schema.ResourceData, v interface{}, pre string) (interface{}, error) {
	return convstr2list(v, nil), nil
}

func expandPackagesFirewallInterfacePolicyDlpProfileStatus(d *schema.ResourceData, v interface{}, pre string) (interface{}, error) {
	return v, nil
}
...
func getObjectPackagesFirewallInterfacePolicy(d *schema.ResourceData) (*map[string]interface{}, error) {
	...
	if v, ok := d.GetOk("casb_profile"); ok || d.HasChange("casb_profile") {
		t, err := expandPackagesFirewallInterfacePolicyCasbProfile(d, v, "casb_profile")
		if err != nil {
			return &obj, err
		} else if t != nil {
			obj["casb-profile"] = t
	...
	if v, ok := d.GetOk("casb_profile_status"); ok || d.HasChange("casb_profile_status") {
		t, err := expandPackagesFirewallInterfacePolicyCasbProfileStatus(d, v, "casb_profile_status")
		if err != nil {
			return &obj, err
		} else if t != nil {
	...
	if v, ok := d.GetOk("dlp_profile"); ok || d.HasChange("dlp_profile") {
		t, err := expandPackagesFirewallInterfacePolicyDlpProfile(d, v, "dlp_profile")
		if err != nil {
			return &obj, err
		} else if t != nil {
			obj["dlp-profile"] = t
	...
	if v, ok := d.GetOk("dlp_profile_status"); ok || d.HasChange("dlp_profile_status") {
		t, err := expandPackagesFirewallInterfacePolicyDlpProfileStatus(d, v, "dlp_profile_status")
		if err != nil {
			return &obj, err
		} else if t != nil {
