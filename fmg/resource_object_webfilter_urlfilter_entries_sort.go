...
func resourceObjectWebfilterUrlfilterEntriesSort() *schema.Resource {
	return &schema.Resource{
		Create: resourceObjectWebfilterUrlfilterEntriesSortCreateUpdate,
		Read:   resourceObjectWebfilterUrlfilterEntriesSortRead,
		Update: resourceObjectWebfilterUrlfilterEntriesSortCreateUpdate,
		Delete: schema.Noop,
...
func resourceObjectWebfilterUrlfilterEntriesSortCreateUpdate(d *schema.ResourceData, m interface{}) (err error) {
	...
	err = c.CreateUpdateObjectWebfilterUrlfilterEntriesSort(&input_model)
	if err != nil {
		return fmt.Errorf("Error sorting ObjectWebfilterUrlfilterEntries: %s", err)
	}

	d.SetId(sortby + sortdirection)

	return resourceObjectWebfilterUrlfilterEntriesSortRead(d, m)
}

func resourceObjectWebfilterUrlfilterEntriesSortRead(d *schema.ResourceData, m interface{}) error {
	mkey := d.Id()
	...
	sorted, o, err := c.ReadObjectWebfilterUrlfilterEntriesSort(&input_model)
	if err != nil {
		return fmt.Errorf("Error reading ObjectWebfilterUrlfilterEntries sort status: %s %s", err, mkey)
	}
	...
	if o != nil {
		if err := d.Set("state_list", o); err != nil {
			log.Printf("[WARN] Error reading ObjectWebfilterUrlfilterEntries List for (%s): %s", d.Id(), err)
		}
	} else {
