...
func resourceObjectWirelessControllerMpskProfileCreate(d *schema.ResourceData, m interface{}) error {
	...
	if update_if_exist && mkey_ok {
		...
		if err == nil && o != nil {
			existing = true
			// update if existing
			o, err = c.UpdateObjectWirelessControllerMpskProfile(obj, mkey, paradict, wsParams)
			if err != nil {
	...
	if !existing {
		_, err = c.CreateObjectWirelessControllerMpskProfile(obj, paradict, wsParams)
		if err != nil {
...
func resourceObjectWirelessControllerMpskProfileUpdate(d *schema.ResourceData, m interface{}) error {
	...
	_, err = c.UpdateObjectWirelessControllerMpskProfile(obj, mkey, paradict, wsParams)
	if err != nil {
		return fmt.Errorf("Error updating ObjectWirelessControllerMpskProfile resource: %v", err)
	}
...
func resourceObjectWirelessControllerMpskProfileDelete(d *schema.ResourceData, m interface{}) error {
	...
	err = c.DeleteObjectWirelessControllerMpskProfile(mkey, paradict, wsParams)
	if err != nil {
