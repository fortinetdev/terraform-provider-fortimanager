...
func resourceObjectSystemExternalResourceSort() *schema.Resource {
	return &schema.Resource{
		Create: resourceObjectSystemExternalResourceSortCreateUpdate,
		Read:   resourceObjectSystemExternalResourceSortRead,
		Update: resourceObjectSystemExternalResourceSortCreateUpdate,
		Delete: schema.Noop,
...
func resourceObjectSystemExternalResourceSortCreateUpdate(d *schema.ResourceData, m interface{}) (err error) {
	...
	err = c.CreateUpdateObjectSystemExternalResourceSort(&input_model)
	if err != nil {
		return fmt.Errorf("Error sorting ObjectSystemExternalResource: %s", err)
	}

	d.SetId(sortby + sortdirection)

	return resourceObjectSystemExternalResourceSortRead(d, m)
}

func resourceObjectSystemExternalResourceSortRead(d *schema.ResourceData, m interface{}) error {
	mkey := d.Id()
	...
	sorted, o, err := c.ReadObjectSystemExternalResourceSort(&input_model)
	if err != nil {
		return fmt.Errorf("Error reading ObjectSystemExternalResource sort status: %s %s", err, mkey)
	}
	...
	if o != nil {
		if err := d.Set("state_list", o); err != nil {
			log.Printf("[WARN] Error reading ObjectSystemExternalResource List for (%s): %s", d.Id(), err)
		}
	} else {
