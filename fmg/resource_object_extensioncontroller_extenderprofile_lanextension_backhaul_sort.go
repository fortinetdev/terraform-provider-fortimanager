...
func resourceObjectExtensionControllerExtenderProfileLanExtensionBackhaulSort() *schema.Resource {
	return &schema.Resource{
		Create: resourceObjectExtensionControllerExtenderProfileLanExtensionBackhaulSortCreateUpdate,
		Read:   resourceObjectExtensionControllerExtenderProfileLanExtensionBackhaulSortRead,
		Update: resourceObjectExtensionControllerExtenderProfileLanExtensionBackhaulSortCreateUpdate,
		Delete: schema.Noop,
...
func resourceObjectExtensionControllerExtenderProfileLanExtensionBackhaulSortCreateUpdate(d *schema.ResourceData, m interface{}) (err error) {
	...
	err = c.CreateUpdateObjectExtensionControllerExtenderProfileLanExtensionBackhaulSort(&input_model)
	if err != nil {
		return fmt.Errorf("Error sorting ObjectExtensionControllerExtenderProfileLanExtensionBackhaul: %s", err)
	}

	d.SetId(sortby + sortdirection)

	return resourceObjectExtensionControllerExtenderProfileLanExtensionBackhaulSortRead(d, m)
}

func resourceObjectExtensionControllerExtenderProfileLanExtensionBackhaulSortRead(d *schema.ResourceData, m interface{}) error {
	mkey := d.Id()
	...
	sorted, o, err := c.ReadObjectExtensionControllerExtenderProfileLanExtensionBackhaulSort(&input_model)
	if err != nil {
		return fmt.Errorf("Error reading ObjectExtensionControllerExtenderProfileLanExtensionBackhaul sort status: %s %s", err, mkey)
	}
	...
	if o != nil {
		if err := d.Set("state_list", o); err != nil {
			log.Printf("[WARN] Error reading ObjectExtensionControllerExtenderProfileLanExtensionBackhaul List for (%s): %s", d.Id(), err)
		}
	} else {
