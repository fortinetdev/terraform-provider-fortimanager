...
func resourceObjectVideofilterProfileFortiguardCategoryFiltersSort() *schema.Resource {
	return &schema.Resource{
		Create: resourceObjectVideofilterProfileFortiguardCategoryFiltersSortCreateUpdate,
		Read:   resourceObjectVideofilterProfileFortiguardCategoryFiltersSortRead,
		Update: resourceObjectVideofilterProfileFortiguardCategoryFiltersSortCreateUpdate,
		Delete: schema.Noop,
...
func resourceObjectVideofilterProfileFortiguardCategoryFiltersSortCreateUpdate(d *schema.ResourceData, m interface{}) (err error) {
	...
	err = c.CreateUpdateObjectVideofilterProfileFortiguardCategoryFiltersSort(&input_model)
	if err != nil {
		return fmt.Errorf("Error sorting ObjectVideofilterProfileFortiguardCategoryFilters: %s", err)
	}

	d.SetId(sortby + sortdirection)

	return resourceObjectVideofilterProfileFortiguardCategoryFiltersSortRead(d, m)
}

func resourceObjectVideofilterProfileFortiguardCategoryFiltersSortRead(d *schema.ResourceData, m interface{}) error {
	mkey := d.Id()
	...
	sorted, o, err := c.ReadObjectVideofilterProfileFortiguardCategoryFiltersSort(&input_model)
	if err != nil {
		return fmt.Errorf("Error reading ObjectVideofilterProfileFortiguardCategoryFilters sort status: %s %s", err, mkey)
	}
	...
	if o != nil {
		if err := d.Set("state_list", o); err != nil {
			log.Printf("[WARN] Error reading ObjectVideofilterProfileFortiguardCategoryFilters List for (%s): %s", d.Id(), err)
		}
	} else {
