...
func resourcePackagesFirewallShapingPolicyMoveUpdate(d *schema.ResourceData, m interface{}) error {
	...
	_, err = c.UpdatePackagesFirewallShapingPolicyMove(obj, mkey, paradict, wsParams)
	if err != nil {
	...
	d.SetId("PackagesFirewallShapingPolicyMove" + "_" + pkg_folder_path + "_" + pkg + "_" + shaping_policy + "_" + target)
