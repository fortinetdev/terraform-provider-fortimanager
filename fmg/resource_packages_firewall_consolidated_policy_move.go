...
func resourcePackagesFirewallConsolidatedPolicyMoveUpdate(d *schema.ResourceData, m interface{}) error {
	...
	_, err = c.UpdatePackagesFirewallConsolidatedPolicyMove(obj, mkey, paradict, wsParams)
	if err != nil {
	...
	d.SetId("PackagesFirewallConsolidatedPolicyMove" + "_" + pkg_folder_path + "_" + pkg + "_" + policy + "_" + target)
