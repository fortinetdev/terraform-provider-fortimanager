...
func resourceObjectWirelessControllerMpskProfileMpskGroupSort() *schema.Resource {
	return &schema.Resource{
		Create: resourceObjectWirelessControllerMpskProfileMpskGroupSortCreateUpdate,
		Read:   resourceObjectWirelessControllerMpskProfileMpskGroupSortRead,
		Update: resourceObjectWirelessControllerMpskProfileMpskGroupSortCreateUpdate,
		Delete: schema.Noop,
...
func resourceObjectWirelessControllerMpskProfileMpskGroupSortCreateUpdate(d *schema.ResourceData, m interface{}) (err error) {
	...
	err = c.CreateUpdateObjectWirelessControllerMpskProfileMpskGroupSort(&input_model)
	if err != nil {
		return fmt.Errorf("Error sorting ObjectWirelessControllerMpskProfileMpskGroup: %s", err)
	}

	d.SetId(sortby + sortdirection)

	return resourceObjectWirelessControllerMpskProfileMpskGroupSortRead(d, m)
}

func resourceObjectWirelessControllerMpskProfileMpskGroupSortRead(d *schema.ResourceData, m interface{}) error {
	mkey := d.Id()
	...
	sorted, o, err := c.ReadObjectWirelessControllerMpskProfileMpskGroupSort(&input_model)
	if err != nil {
		return fmt.Errorf("Error reading ObjectWirelessControllerMpskProfileMpskGroup sort status: %s %s", err, mkey)
	}
	...
	if o != nil {
		if err := d.Set("state_list", o); err != nil {
			log.Printf("[WARN] Error reading ObjectWirelessControllerMpskProfileMpskGroup List for (%s): %s", d.Id(), err)
		}
	} else {
