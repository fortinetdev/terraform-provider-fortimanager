...
func resourceObjectDynamicInterfacePlatformMappingCreate(d *schema.ResourceData, m interface{}) error {
	...
	if update_if_exist && mkey_ok {
		...
		if err == nil && o != nil {
			existing = true
			// update if existing
			o, err = c.UpdateObjectDynamicInterfacePlatformMapping(obj, mkey, paradict, wsParams)
			if err != nil {
	...
	if !existing {
		_, err = c.CreateObjectDynamicInterfacePlatformMapping(obj, paradict, wsParams)
		if err != nil {
...
func resourceObjectDynamicInterfacePlatformMappingUpdate(d *schema.ResourceData, m interface{}) error {
	...
	_, err = c.UpdateObjectDynamicInterfacePlatformMapping(obj, mkey, paradict, wsParams)
	if err != nil {
		return fmt.Errorf("Error updating ObjectDynamicInterfacePlatformMapping resource: %v", err)
	}
...
func resourceObjectDynamicInterfacePlatformMappingDelete(d *schema.ResourceData, m interface{}) error {
	...
	err = c.DeleteObjectDynamicInterfacePlatformMapping(mkey, paradict, wsParams)
	if err != nil {
