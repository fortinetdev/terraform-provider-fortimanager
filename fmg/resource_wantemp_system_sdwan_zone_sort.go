...
func resourceWantempSystemSdwanZoneSort() *schema.Resource {
	return &schema.Resource{
		Create: resourceWantempSystemSdwanZoneSortCreateUpdate,
		Read:   resourceWantempSystemSdwanZoneSortRead,
		Update: resourceWantempSystemSdwanZoneSortCreateUpdate,
		Delete: schema.Noop,
...
func resourceWantempSystemSdwanZoneSortCreateUpdate(d *schema.ResourceData, m interface{}) (err error) {
	...
	err = c.CreateUpdateWantempSystemSdwanZoneSort(&input_model)
	if err != nil {
		return fmt.Errorf("Error sorting WantempSystemSdwanZone: %s", err)
	}

	d.SetId(sortby + sortdirection)

	return resourceWantempSystemSdwanZoneSortRead(d, m)
}

func resourceWantempSystemSdwanZoneSortRead(d *schema.ResourceData, m interface{}) error {
	mkey := d.Id()
	...
	sorted, o, err := c.ReadWantempSystemSdwanZoneSort(&input_model)
	if err != nil {
		return fmt.Errorf("Error reading WantempSystemSdwanZone sort status: %s %s", err, mkey)
	}
	...
	if o != nil {
		if err := d.Set("state_list", o); err != nil {
			log.Printf("[WARN] Error reading WantempSystemSdwanZone List for (%s): %s", d.Id(), err)
		}
	} else {
