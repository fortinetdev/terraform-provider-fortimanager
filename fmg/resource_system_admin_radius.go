...
func resourceSystemAdminRadiusCreate(d *schema.ResourceData, m interface{}) error {
	...
	if update_if_exist && mkey_ok {
		...
		if err == nil && o != nil {
			existing = true
			// update if existing
			o, err = c.UpdateSystemAdminRadius(obj, mkey, paradict, wsParams)
			if err != nil {
	...
	if !existing {
		_, err = c.CreateSystemAdminRadius(obj, paradict, wsParams)
		if err != nil {
...
func resourceSystemAdminRadiusUpdate(d *schema.ResourceData, m interface{}) error {
	...
	_, err = c.UpdateSystemAdminRadius(obj, mkey, paradict, wsParams)
	if err != nil {
		return fmt.Errorf("Error updating SystemAdminRadius resource: %v", err)
	}
...
func resourceSystemAdminRadiusDelete(d *schema.ResourceData, m interface{}) error {
	...
	err = c.DeleteSystemAdminRadius(mkey, paradict, wsParams)
	if err != nil {
