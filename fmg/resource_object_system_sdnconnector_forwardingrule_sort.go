...
func resourceObjectSystemSdnConnectorForwardingRuleSort() *schema.Resource {
	return &schema.Resource{
		Create: resourceObjectSystemSdnConnectorForwardingRuleSortCreateUpdate,
		Read:   resourceObjectSystemSdnConnectorForwardingRuleSortRead,
		Update: resourceObjectSystemSdnConnectorForwardingRuleSortCreateUpdate,
		Delete: schema.Noop,
...
func resourceObjectSystemSdnConnectorForwardingRuleSortCreateUpdate(d *schema.ResourceData, m interface{}) (err error) {
	...
	err = c.CreateUpdateObjectSystemSdnConnectorForwardingRuleSort(&input_model)
	if err != nil {
		return fmt.Errorf("Error sorting ObjectSystemSdnConnectorForwardingRule: %s", err)
	}

	d.SetId(sortby + sortdirection)

	return resourceObjectSystemSdnConnectorForwardingRuleSortRead(d, m)
}

func resourceObjectSystemSdnConnectorForwardingRuleSortRead(d *schema.ResourceData, m interface{}) error {
	mkey := d.Id()
	...
	sorted, o, err := c.ReadObjectSystemSdnConnectorForwardingRuleSort(&input_model)
	if err != nil {
		return fmt.Errorf("Error reading ObjectSystemSdnConnectorForwardingRule sort status: %s %s", err, mkey)
	}
	...
	if o != nil {
		if err := d.Set("state_list", o); err != nil {
			log.Printf("[WARN] Error reading ObjectSystemSdnConnectorForwardingRule List for (%s): %s", d.Id(), err)
		}
	} else {
