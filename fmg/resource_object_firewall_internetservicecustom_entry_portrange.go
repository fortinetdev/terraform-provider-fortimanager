...
func resourceObjectFirewallInternetServiceCustomEntryPortRangeCreate(d *schema.ResourceData, m interface{}) error {
	...
	if update_if_exist && mkey_ok {
		...
		if err == nil && o != nil {
			existing = true
			// update if existing
			o, err = c.UpdateObjectFirewallInternetServiceCustomEntryPortRange(obj, mkey, paradict, wsParams)
			if err != nil {
	...
	if !existing {
		_, err = c.CreateObjectFirewallInternetServiceCustomEntryPortRange(obj, paradict, wsParams)
		if err != nil {
...
func resourceObjectFirewallInternetServiceCustomEntryPortRangeUpdate(d *schema.ResourceData, m interface{}) error {
	...
	_, err = c.UpdateObjectFirewallInternetServiceCustomEntryPortRange(obj, mkey, paradict, wsParams)
	if err != nil {
		return fmt.Errorf("Error updating ObjectFirewallInternetServiceCustomEntryPortRange resource: %v", err)
	}
...
func resourceObjectFirewallInternetServiceCustomEntryPortRangeDelete(d *schema.ResourceData, m interface{}) error {
	...
	err = c.DeleteObjectFirewallInternetServiceCustomEntryPortRange(mkey, paradict, wsParams)
	if err != nil {
