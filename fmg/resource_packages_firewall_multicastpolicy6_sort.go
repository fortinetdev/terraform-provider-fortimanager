...
func resourcePackagesFirewallMulticastPolicy6Sort() *schema.Resource {
	return &schema.Resource{
		Create: resourcePackagesFirewallMulticastPolicy6SortCreateUpdate,
		Read:   resourcePackagesFirewallMulticastPolicy6SortRead,
		Update: resourcePackagesFirewallMulticastPolicy6SortCreateUpdate,
		Delete: schema.Noop,
...
func resourcePackagesFirewallMulticastPolicy6SortCreateUpdate(d *schema.ResourceData, m interface{}) (err error) {
	...
	err = c.CreateUpdatePackagesFirewallMulticastPolicy6Sort(&input_model)
	if err != nil {
		return fmt.Errorf("Error sorting PackagesFirewallMulticastPolicy6: %s", err)
	}

	d.SetId(sortby + sortdirection)

	return resourcePackagesFirewallMulticastPolicy6SortRead(d, m)
}

func resourcePackagesFirewallMulticastPolicy6SortRead(d *schema.ResourceData, m interface{}) error {
	mkey := d.Id()
	...
	sorted, o, err := c.ReadPackagesFirewallMulticastPolicy6Sort(&input_model)
	if err != nil {
		return fmt.Errorf("Error reading PackagesFirewallMulticastPolicy6 sort status: %s %s", err, mkey)
	}
	...
	if o != nil {
		if err := d.Set("state_list", o); err != nil {
			log.Printf("[WARN] Error reading PackagesFirewallMulticastPolicy6 List for (%s): %s", d.Id(), err)
		}
	} else {
