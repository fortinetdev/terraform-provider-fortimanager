...
func resourceObjectWirelessControllerMpskProfileMpskGroupMpskKeySort() *schema.Resource {
	return &schema.Resource{
		Create: resourceObjectWirelessControllerMpskProfileMpskGroupMpskKeySortCreateUpdate,
		Read:   resourceObjectWirelessControllerMpskProfileMpskGroupMpskKeySortRead,
		Update: resourceObjectWirelessControllerMpskProfileMpskGroupMpskKeySortCreateUpdate,
		Delete: schema.Noop,
...
func resourceObjectWirelessControllerMpskProfileMpskGroupMpskKeySortCreateUpdate(d *schema.ResourceData, m interface{}) (err error) {
	...
	err = c.CreateUpdateObjectWirelessControllerMpskProfileMpskGroupMpskKeySort(&input_model)
	if err != nil {
		return fmt.Errorf("Error sorting ObjectWirelessControllerMpskProfileMpskGroupMpskKey: %s", err)
	}

	d.SetId(sortby + sortdirection)

	return resourceObjectWirelessControllerMpskProfileMpskGroupMpskKeySortRead(d, m)
}

func resourceObjectWirelessControllerMpskProfileMpskGroupMpskKeySortRead(d *schema.ResourceData, m interface{}) error {
	mkey := d.Id()
	...
	sorted, o, err := c.ReadObjectWirelessControllerMpskProfileMpskGroupMpskKeySort(&input_model)
	if err != nil {
		return fmt.Errorf("Error reading ObjectWirelessControllerMpskProfileMpskGroupMpskKey sort status: %s %s", err, mkey)
	}
	...
	if o != nil {
		if err := d.Set("state_list", o); err != nil {
			log.Printf("[WARN] Error reading ObjectWirelessControllerMpskProfileMpskGroupMpskKey List for (%s): %s", d.Id(), err)
		}
	} else {
