...
func resourceObjectSystemSdnConnectorCompartmentListSort() *schema.Resource {
	return &schema.Resource{
		Create: resourceObjectSystemSdnConnectorCompartmentListSortCreateUpdate,
		Read:   resourceObjectSystemSdnConnectorCompartmentListSortRead,
		Update: resourceObjectSystemSdnConnectorCompartmentListSortCreateUpdate,
		Delete: schema.Noop,
...
func resourceObjectSystemSdnConnectorCompartmentListSortCreateUpdate(d *schema.ResourceData, m interface{}) (err error) {
	...
	err = c.CreateUpdateObjectSystemSdnConnectorCompartmentListSort(&input_model)
	if err != nil {
		return fmt.Errorf("Error sorting ObjectSystemSdnConnectorCompartmentList: %s", err)
	}

	d.SetId(sortby + sortdirection)

	return resourceObjectSystemSdnConnectorCompartmentListSortRead(d, m)
}

func resourceObjectSystemSdnConnectorCompartmentListSortRead(d *schema.ResourceData, m interface{}) error {
	mkey := d.Id()
	...
	sorted, o, err := c.ReadObjectSystemSdnConnectorCompartmentListSort(&input_model)
	if err != nil {
		return fmt.Errorf("Error reading ObjectSystemSdnConnectorCompartmentList sort status: %s %s", err, mkey)
	}
	...
	if o != nil {
		if err := d.Set("state_list", o); err != nil {
			log.Printf("[WARN] Error reading ObjectSystemSdnConnectorCompartmentList List for (%s): %s", d.Id(), err)
		}
	} else {
