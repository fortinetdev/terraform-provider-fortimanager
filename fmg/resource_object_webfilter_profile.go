...
func resourceObjectWebfilterProfileCreate(d *schema.ResourceData, m interface{}) error {
	...
	if update_if_exist && mkey_ok {
		// check existing
		o, err = c.ReadObjectWebfilterProfile(mkey, paradict)
		if err == nil && o != nil {
			existing = true
			// update if existing
			o, err = c.UpdateObjectWebfilterProfile(obj, mkey, paradict, wsParams)
			if err != nil {
	...
	if !existing {
		_, err = c.CreateObjectWebfilterProfile(obj, paradict, wsParams)
		if err != nil {
...
func resourceObjectWebfilterProfileUpdate(d *schema.ResourceData, m interface{}) error {
	...
	_, err = c.UpdateObjectWebfilterProfile(obj, mkey, paradict, wsParams)
	if err != nil {
		return fmt.Errorf("Error updating ObjectWebfilterProfile resource: %v", err)
	}
...
func resourceObjectWebfilterProfileDelete(d *schema.ResourceData, m interface{}) error {
	...
	err = c.DeleteObjectWebfilterProfile(mkey, paradict, wsParams)
	if err != nil {
...
func flattenObjectWebfilterProfileFabricForceSync(v interface{}, d *schema.ResourceData, pre string) interface{} {
	return v
}

func flattenObjectWebfilterProfileFabricObject(v interface{}, d *schema.ResourceData, pre string) interface{} {
	return v
}

func flattenObjectWebfilterProfileFabricObjectSource(v interface{}, d *schema.ResourceData, pre string) interface{} {
	return v
}
...
func flattenObjectWebfilterProfileFtgdWf(v interface{}, d *schema.ResourceData, pre string) []map[string]interface{} {
	...
	if _, ok := i["risk"]; ok {
		result["risk"] = flattenObjectWebfilterProfileFtgdWfRisk(i["risk"], d, pre_append)
	}
...
func flattenObjectWebfilterProfileFtgdWfRisk(v interface{}, d *schema.ResourceData, pre string) []map[string]interface{} {
	if v == nil {
		return nil
	}
	...
	for _, r := range l {
		...
		pre_append = pre + "." + strconv.Itoa(con) + "." + "action"
		if _, ok := i["action"]; ok {
			v := flattenObjectWebfilterProfileFtgdWfRiskAction(i["action"], d, pre_append)
			tmp["action"] = fortiAPISubPartPatch(v, "ObjectWebfilterProfileFtgdWf-Risk-Action")
		}

		pre_append = pre + "." + strconv.Itoa(con) + "." + "id"
		if _, ok := i["id"]; ok {
			v := flattenObjectWebfilterProfileFtgdWfRiskId(i["id"], d, pre_append)
			tmp["id"] = fortiAPISubPartPatch(v, "ObjectWebfilterProfileFtgdWf-Risk-Id")
		}

		pre_append = pre + "." + strconv.Itoa(con) + "." + "log"
		if _, ok := i["log"]; ok {
			v := flattenObjectWebfilterProfileFtgdWfRiskLog(i["log"], d, pre_append)
		...
		if _, ok := i["risk-level"]; ok {
			v := flattenObjectWebfilterProfileFtgdWfRiskRiskLevel(i["risk-level"], d, pre_append)
...
func flattenObjectWebfilterProfileFtgdWfRiskAction(v interface{}, d *schema.ResourceData, pre string) interface{} {
	return v
}

func flattenObjectWebfilterProfileFtgdWfRiskId(v interface{}, d *schema.ResourceData, pre string) interface{} {
	return v
}

func flattenObjectWebfilterProfileFtgdWfRiskLog(v interface{}, d *schema.ResourceData, pre string) interface{} {
	return v
}

func flattenObjectWebfilterProfileFtgdWfRiskRiskLevel(v interface{}, d *schema.ResourceData, pre string) interface{} {
	return flattenStringList(v)
}
...
func flattenObjectWebfilterProfileUuid(v interface{}, d *schema.ResourceData, pre string) interface{} {
	return v
}
...
func refreshObjectObjectWebfilterProfile(d *schema.ResourceData, o map[string]interface{}) error {
	...
	if err = d.Set("fabric_force_sync", flattenObjectWebfilterProfileFabricForceSync(o["fabric-force-sync"], d, "fabric_force_sync")); err != nil {
		if vv, ok := fortiAPIPatch(o["fabric-force-sync"], "ObjectWebfilterProfile-FabricForceSync"); ok {
	...
	if err = d.Set("fabric_object", flattenObjectWebfilterProfileFabricObject(o["fabric-object"], d, "fabric_object")); err != nil {
		if vv, ok := fortiAPIPatch(o["fabric-object"], "ObjectWebfilterProfile-FabricObject"); ok {
	...
	if err = d.Set("fabric_object_source", flattenObjectWebfilterProfileFabricObjectSource(o["fabric-object-source"], d, "fabric_object_source")); err != nil {
		if vv, ok := fortiAPIPatch(o["fabric-object-source"], "ObjectWebfilterProfile-FabricObjectSource"); ok {
	...
	if err = d.Set("uuid", flattenObjectWebfilterProfileUuid(o["uuid"], d, "uuid")); err != nil {
		if vv, ok := fortiAPIPatch(o["uuid"], "ObjectWebfilterProfile-Uuid"); ok {
...
func expandObjectWebfilterProfileAntiphish(d *schema.ResourceData, v interface{}, pre string) (interface{}, error) {
	...
	pre_append = pre + ".0." + "custom_patterns"
	if _, ok := d.GetOk(pre_append); ok || d.HasChange(pre_append) {
		t, err := expandObjectWebfilterProfileAntiphishCustomPatterns(d, i["custom_patterns"], pre_append)
		if err != nil {
			return result, err
		} else if t != nil {
	...
	pre_append = pre + ".0." + "inspection_entries"
	if _, ok := d.GetOk(pre_append); ok || d.HasChange(pre_append) {
		t, err := expandObjectWebfilterProfileAntiphishInspectionEntries(d, i["inspection_entries"], pre_append)
		if err != nil {
			return result, err
		} else if t != nil {
...
func expandObjectWebfilterProfileFabricForceSync(d *schema.ResourceData, v interface{}, pre string) (interface{}, error) {
	return v, nil
}

func expandObjectWebfilterProfileFabricObject(d *schema.ResourceData, v interface{}, pre string) (interface{}, error) {
	return v, nil
}

func expandObjectWebfilterProfileFabricObjectSource(d *schema.ResourceData, v interface{}, pre string) (interface{}, error) {
	return v, nil
}
...
func expandObjectWebfilterProfileFileFilter(d *schema.ResourceData, v interface{}, pre string) (interface{}, error) {
	...
	pre_append = pre + ".0." + "entries"
	if _, ok := d.GetOk(pre_append); ok || d.HasChange(pre_append) {
		t, err := expandObjectWebfilterProfileFileFilterEntries(d, i["entries"], pre_append)
		if err != nil {
			return result, err
		} else if t != nil {
			result["entries"] = t
...
func expandObjectWebfilterProfileFtgdWf(d *schema.ResourceData, v interface{}, pre string) (interface{}, error) {
	...
	pre_append = pre + ".0." + "filters"
	if _, ok := d.GetOk(pre_append); ok || d.HasChange(pre_append) {
		t, err := expandObjectWebfilterProfileFtgdWfFilters(d, i["filters"], pre_append)
		if err != nil {
			return result, err
		} else if t != nil {
			result["filters"] = t
	...
	pre_append = pre + ".0." + "quota"
	if _, ok := d.GetOk(pre_append); ok || d.HasChange(pre_append) {
		t, err := expandObjectWebfilterProfileFtgdWfQuota(d, i["quota"], pre_append)
		if err != nil {
			return result, err
		} else if t != nil {
			result["quota"] = t
	...
	pre_append = pre + ".0." + "risk"
	if _, ok := d.GetOk(pre_append); ok || d.HasChange(pre_append) {
		t, err := expandObjectWebfilterProfileFtgdWfRisk(d, i["risk"], pre_append)
		if err != nil {
			return result, err
		} else if t != nil {
			result["risk"] = t
...
func expandObjectWebfilterProfileFtgdWfRisk(d *schema.ResourceData, v interface{}, pre string) (interface{}, error) {
	l := v.([]interface{})
	result := make([]map[string]interface{}, 0, len(l))
	...
	for _, r := range l {
		...
		pre_append = pre + "." + strconv.Itoa(con) + "." + "action"
		if _, ok := d.GetOk(pre_append); ok || d.HasChange(pre_append) {
			tmp["action"], _ = expandObjectWebfilterProfileFtgdWfRiskAction(d, i["action"], pre_append)
		}

		pre_append = pre + "." + strconv.Itoa(con) + "." + "id"
		if _, ok := d.GetOk(pre_append); ok || d.HasChange(pre_append) {
			tmp["id"], _ = expandObjectWebfilterProfileFtgdWfRiskId(d, i["id"], pre_append)
		}

		pre_append = pre + "." + strconv.Itoa(con) + "." + "log"
		if _, ok := d.GetOk(pre_append); ok || d.HasChange(pre_append) {
			tmp["log"], _ = expandObjectWebfilterProfileFtgdWfRiskLog(d, i["log"], pre_append)
		}

		pre_append = pre + "." + strconv.Itoa(con) + "." + "risk_level"
		if _, ok := d.GetOk(pre_append); ok || d.HasChange(pre_append) {
			tmp["risk-level"], _ = expandObjectWebfilterProfileFtgdWfRiskRiskLevel(d, i["risk_level"], pre_append)
		}
...
func expandObjectWebfilterProfileFtgdWfRiskAction(d *schema.ResourceData, v interface{}, pre string) (interface{}, error) {
	return v, nil
}

func expandObjectWebfilterProfileFtgdWfRiskId(d *schema.ResourceData, v interface{}, pre string) (interface{}, error) {
	return v, nil
}

func expandObjectWebfilterProfileFtgdWfRiskLog(d *schema.ResourceData, v interface{}, pre string) (interface{}, error) {
	return v, nil
}

func expandObjectWebfilterProfileFtgdWfRiskRiskLevel(d *schema.ResourceData, v interface{}, pre string) (interface{}, error) {
	return expandStringList(v.(*schema.Set).List()), nil
}
...
func expandObjectWebfilterProfileUuid(d *schema.ResourceData, v interface{}, pre string) (interface{}, error) {
	return v, nil
}
...
func getObjectObjectWebfilterProfile(d *schema.ResourceData) (*map[string]interface{}, error) {
	...
	if v, ok := d.GetOk("fabric_force_sync"); ok || d.HasChange("fabric_force_sync") {
		t, err := expandObjectWebfilterProfileFabricForceSync(d, v, "fabric_force_sync")
		if err != nil {
			return &obj, err
		} else if t != nil {
	...
	if v, ok := d.GetOk("fabric_object"); ok || d.HasChange("fabric_object") {
		t, err := expandObjectWebfilterProfileFabricObject(d, v, "fabric_object")
		if err != nil {
			return &obj, err
		} else if t != nil {
			obj["fabric-object"] = t
	...
	if v, ok := d.GetOk("fabric_object_source"); ok || d.HasChange("fabric_object_source") {
		t, err := expandObjectWebfilterProfileFabricObjectSource(d, v, "fabric_object_source")
		if err != nil {
			return &obj, err
		} else if t != nil {
	...
	if v, ok := d.GetOk("uuid"); ok || d.HasChange("uuid") {
		t, err := expandObjectWebfilterProfileUuid(d, v, "uuid")
		if err != nil {
			return &obj, err
		} else if t != nil {
			obj["uuid"] = t
