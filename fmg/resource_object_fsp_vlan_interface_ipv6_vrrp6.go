...
func resourceObjectFspVlanInterfaceIpv6Vrrp6Create(d *schema.ResourceData, m interface{}) error {
	...
	if update_if_exist && mkey_ok {
		...
		if err == nil && o != nil {
			existing = true
			// update if existing
			o, err = c.UpdateObjectFspVlanInterfaceIpv6Vrrp6(obj, mkey, paradict, wsParams)
			if err != nil {
	...
	if !existing {
		_, err = c.CreateObjectFspVlanInterfaceIpv6Vrrp6(obj, paradict, wsParams)
		if err != nil {
...
func resourceObjectFspVlanInterfaceIpv6Vrrp6Update(d *schema.ResourceData, m interface{}) error {
	...
	_, err = c.UpdateObjectFspVlanInterfaceIpv6Vrrp6(obj, mkey, paradict, wsParams)
	if err != nil {
		return fmt.Errorf("Error updating ObjectFspVlanInterfaceIpv6Vrrp6 resource: %v", err)
	}
...
func resourceObjectFspVlanInterfaceIpv6Vrrp6Delete(d *schema.ResourceData, m interface{}) error {
	...
	err = c.DeleteObjectFspVlanInterfaceIpv6Vrrp6(mkey, paradict, wsParams)
	if err != nil {
