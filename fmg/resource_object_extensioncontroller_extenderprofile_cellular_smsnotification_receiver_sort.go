...
func resourceObjectExtensionControllerExtenderProfileCellularSmsNotificationReceiverSort() *schema.Resource {
	return &schema.Resource{
		Create: resourceObjectExtensionControllerExtenderProfileCellularSmsNotificationReceiverSortCreateUpdate,
		Read:   resourceObjectExtensionControllerExtenderProfileCellularSmsNotificationReceiverSortRead,
		Update: resourceObjectExtensionControllerExtenderProfileCellularSmsNotificationReceiverSortCreateUpdate,
		Delete: schema.Noop,
...
func resourceObjectExtensionControllerExtenderProfileCellularSmsNotificationReceiverSortCreateUpdate(d *schema.ResourceData, m interface{}) (err error) {
	...
	err = c.CreateUpdateObjectExtensionControllerExtenderProfileCellularSmsNotificationReceiverSort(&input_model)
	if err != nil {
		return fmt.Errorf("Error sorting ObjectExtensionControllerExtenderProfileCellularSmsNotificationReceiver: %s", err)
	}

	d.SetId(sortby + sortdirection)

	return resourceObjectExtensionControllerExtenderProfileCellularSmsNotificationReceiverSortRead(d, m)
}

func resourceObjectExtensionControllerExtenderProfileCellularSmsNotificationReceiverSortRead(d *schema.ResourceData, m interface{}) error {
	mkey := d.Id()
	...
	sorted, o, err := c.ReadObjectExtensionControllerExtenderProfileCellularSmsNotificationReceiverSort(&input_model)
	if err != nil {
		return fmt.Errorf("Error reading ObjectExtensionControllerExtenderProfileCellularSmsNotificationReceiver sort status: %s %s", err, mkey)
	}
	...
	if o != nil {
		if err := d.Set("state_list", o); err != nil {
			log.Printf("[WARN] Error reading ObjectExtensionControllerExtenderProfileCellularSmsNotificationReceiver List for (%s): %s", d.Id(), err)
		}
	} else {
