...
func resourceObjectVpnIpsecFecMappingsSort() *schema.Resource {
	return &schema.Resource{
		Create: resourceObjectVpnIpsecFecMappingsSortCreateUpdate,
		Read:   resourceObjectVpnIpsecFecMappingsSortRead,
		Update: resourceObjectVpnIpsecFecMappingsSortCreateUpdate,
		Delete: schema.Noop,
...
func resourceObjectVpnIpsecFecMappingsSortCreateUpdate(d *schema.ResourceData, m interface{}) (err error) {
	...
	err = c.CreateUpdateObjectVpnIpsecFecMappingsSort(&input_model)
	if err != nil {
		return fmt.Errorf("Error sorting ObjectVpnIpsecFecMappings: %s", err)
	}

	d.SetId(sortby + sortdirection)

	return resourceObjectVpnIpsecFecMappingsSortRead(d, m)
}

func resourceObjectVpnIpsecFecMappingsSortRead(d *schema.ResourceData, m interface{}) error {
	mkey := d.Id()
	...
	sorted, o, err := c.ReadObjectVpnIpsecFecMappingsSort(&input_model)
	if err != nil {
		return fmt.Errorf("Error reading ObjectVpnIpsecFecMappings sort status: %s %s", err, mkey)
	}
	...
	if o != nil {
		if err := d.Set("state_list", o); err != nil {
			log.Printf("[WARN] Error reading ObjectVpnIpsecFecMappings List for (%s): %s", d.Id(), err)
		}
	} else {
