...
func resourcePackagesFirewallHyperscalePolicy64Create(d *schema.ResourceData, m interface{}) error {
	...
	if update_if_exist && mkey_ok {
		...
		if err == nil && o != nil {
			existing = true
			// update if existing
			o, err = c.UpdatePackagesFirewallHyperscalePolicy64(obj, mkey, paradict, wsParams)
			if err != nil {
	...
	if !existing {
		_, err = c.CreatePackagesFirewallHyperscalePolicy64(obj, paradict, wsParams)
		if err != nil {
...
func resourcePackagesFirewallHyperscalePolicy64Update(d *schema.ResourceData, m interface{}) error {
	...
	_, err = c.UpdatePackagesFirewallHyperscalePolicy64(obj, mkey, paradict, wsParams)
	if err != nil {
		return fmt.Errorf("Error updating PackagesFirewallHyperscalePolicy64 resource: %v", err)
	}
...
func resourcePackagesFirewallHyperscalePolicy64Delete(d *schema.ResourceData, m interface{}) error {
	...
	err = c.DeletePackagesFirewallHyperscalePolicy64(mkey, paradict, wsParams)
	if err != nil {
