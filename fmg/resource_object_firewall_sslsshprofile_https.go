...
func resourceObjectFirewallSslSshProfileHttpsUpdate(d *schema.ResourceData, m interface{}) error {
	...
	obj, err := getObjectObjectFirewallSslSshProfileHttps(d, false)
	if err != nil {
	...
	_, err = c.UpdateObjectFirewallSslSshProfileHttps(obj, mkey, paradict, wsParams)
	if err != nil {
...
func resourceObjectFirewallSslSshProfileHttpsDelete(d *schema.ResourceData, m interface{}) error {
	...
	obj, err := getObjectObjectFirewallSslSshProfileHttps(d, true)
	...
	_, err = c.UpdateObjectFirewallSslSshProfileHttps(obj, mkey, paradict, wsParams)
	if err != nil {
		return fmt.Errorf("Error clearing ObjectFirewallSslSshProfileHttps resource: %v", err)
	}
...
func flattenObjectFirewallSslSshProfileHttpsUdpNotQuic2edl(v interface{}, d *schema.ResourceData, pre string) interface{} {
	return v
}
...
func refreshObjectObjectFirewallSslSshProfileHttps(d *schema.ResourceData, o map[string]interface{}) error {
	...
	if err = d.Set("udp_not_quic", flattenObjectFirewallSslSshProfileHttpsUdpNotQuic2edl(o["udp-not-quic"], d, "udp_not_quic")); err != nil {
		if vv, ok := fortiAPIPatch(o["udp-not-quic"], "ObjectFirewallSslSshProfileHttps-UdpNotQuic"); ok {
...
func expandObjectFirewallSslSshProfileHttpsUdpNotQuic2edl(d *schema.ResourceData, v interface{}, pre string) (interface{}, error) {
	return v, nil
}
...
func getObjectObjectFirewallSslSshProfileHttps(d *schema.ResourceData, bemptysontable bool) (*map[string]interface{}, error) {
	...
	if v, ok := d.GetOk("udp_not_quic"); ok || d.HasChange("udp_not_quic") {
		t, err := expandObjectFirewallSslSshProfileHttpsUdpNotQuic2edl(d, v, "udp_not_quic")
		if err != nil {
			return &obj, err
		} else if t != nil {
			obj["udp-not-quic"] = t
