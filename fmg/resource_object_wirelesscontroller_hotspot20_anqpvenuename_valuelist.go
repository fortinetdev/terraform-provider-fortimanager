...
func resourceObjectWirelessControllerHotspot20AnqpVenueNameValueListCreate(d *schema.ResourceData, m interface{}) error {
	...
	if update_if_exist && mkey_ok {
		...
		if err == nil && o != nil {
			existing = true
			// update if existing
			o, err = c.UpdateObjectWirelessControllerHotspot20AnqpVenueNameValueList(obj, mkey, paradict, wsParams)
			if err != nil {
	...
	if !existing {
		_, err = c.CreateObjectWirelessControllerHotspot20AnqpVenueNameValueList(obj, paradict, wsParams)
		if err != nil {
...
func resourceObjectWirelessControllerHotspot20AnqpVenueNameValueListUpdate(d *schema.ResourceData, m interface{}) error {
	...
	_, err = c.UpdateObjectWirelessControllerHotspot20AnqpVenueNameValueList(obj, mkey, paradict, wsParams)
	if err != nil {
		return fmt.Errorf("Error updating ObjectWirelessControllerHotspot20AnqpVenueNameValueList resource: %v", err)
	}
...
func resourceObjectWirelessControllerHotspot20AnqpVenueNameValueListDelete(d *schema.ResourceData, m interface{}) error {
	...
	err = c.DeleteObjectWirelessControllerHotspot20AnqpVenueNameValueList(mkey, paradict, wsParams)
	if err != nil {
