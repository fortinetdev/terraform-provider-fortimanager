...
func resourceObjectWirelessControllerMpskProfileMpskGroupMpskKeyCreate(d *schema.ResourceData, m interface{}) error {
	...
	if update_if_exist && mkey_ok {
		...
		if err == nil && o != nil {
			existing = true
			// update if existing
			o, err = c.UpdateObjectWirelessControllerMpskProfileMpskGroupMpskKey(obj, mkey, paradict, wsParams)
			if err != nil {
	...
	if !existing {
		_, err = c.CreateObjectWirelessControllerMpskProfileMpskGroupMpskKey(obj, paradict, wsParams)
		if err != nil {
...
func resourceObjectWirelessControllerMpskProfileMpskGroupMpskKeyUpdate(d *schema.ResourceData, m interface{}) error {
	...
	_, err = c.UpdateObjectWirelessControllerMpskProfileMpskGroupMpskKey(obj, mkey, paradict, wsParams)
	if err != nil {
		return fmt.Errorf("Error updating ObjectWirelessControllerMpskProfileMpskGroupMpskKey resource: %v", err)
	}
...
func resourceObjectWirelessControllerMpskProfileMpskGroupMpskKeyDelete(d *schema.ResourceData, m interface{}) error {
	...
	err = c.DeleteObjectWirelessControllerMpskProfileMpskGroupMpskKey(mkey, paradict, wsParams)
	if err != nil {
