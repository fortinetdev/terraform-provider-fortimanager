...
func resourceObjectWirelessControllerApcfgProfileCommandListCreate(d *schema.ResourceData, m interface{}) error {
	...
	if update_if_exist && mkey_ok {
		...
		if err == nil && o != nil {
			existing = true
			// update if existing
			o, err = c.UpdateObjectWirelessControllerApcfgProfileCommandList(obj, mkey, paradict, wsParams)
			if err != nil {
	...
	if !existing {
		_, err = c.CreateObjectWirelessControllerApcfgProfileCommandList(obj, paradict, wsParams)
		if err != nil {
...
func resourceObjectWirelessControllerApcfgProfileCommandListUpdate(d *schema.ResourceData, m interface{}) error {
	...
	_, err = c.UpdateObjectWirelessControllerApcfgProfileCommandList(obj, mkey, paradict, wsParams)
	if err != nil {
		return fmt.Errorf("Error updating ObjectWirelessControllerApcfgProfileCommandList resource: %v", err)
	}
...
func resourceObjectWirelessControllerApcfgProfileCommandListDelete(d *schema.ResourceData, m interface{}) error {
	...
	err = c.DeleteObjectWirelessControllerApcfgProfileCommandList(mkey, paradict, wsParams)
	if err != nil {
