...
func resourceObjectFirewallVipgrp46Create(d *schema.ResourceData, m interface{}) error {
	...
	if update_if_exist && mkey_ok {
		...
		if err == nil && o != nil {
			existing = true
			// update if existing
			o, err = c.UpdateObjectFirewallVipgrp46(obj, mkey, paradict, wsParams)
			if err != nil {
	...
	if !existing {
		_, err = c.CreateObjectFirewallVipgrp46(obj, paradict, wsParams)
		if err != nil {
...
func resourceObjectFirewallVipgrp46Update(d *schema.ResourceData, m interface{}) error {
	...
	_, err = c.UpdateObjectFirewallVipgrp46(obj, mkey, paradict, wsParams)
	if err != nil {
		return fmt.Errorf("Error updating ObjectFirewallVipgrp46 resource: %v", err)
	}
...
func resourceObjectFirewallVipgrp46Delete(d *schema.ResourceData, m interface{}) error {
	...
	err = c.DeleteObjectFirewallVipgrp46(mkey, paradict, wsParams)
	if err != nil {
