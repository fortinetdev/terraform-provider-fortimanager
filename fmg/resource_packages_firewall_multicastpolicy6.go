...
func resourcePackagesFirewallMulticastPolicy6Create(d *schema.ResourceData, m interface{}) error {
	...
	if update_if_exist && mkey_ok {
		...
		if err == nil && o != nil {
			existing = true
			// update if existing
			o, err = c.UpdatePackagesFirewallMulticastPolicy6(obj, mkey, paradict, wsParams)
			if err != nil {
...
func flattenPackagesFirewallMulticastPolicy6CustomTags(v interface{}, d *schema.ResourceData, pre string) interface{} {
...
func flattenPackagesFirewallMulticastPolicy6UtmStatus(v interface{}, d *schema.ResourceData, pre string) interface{} {
	return v
}
...
func refreshObjectPackagesFirewallMulticastPolicy6(d *schema.ResourceData, o map[string]interface{}) error {
	...
	if err = d.Set("custom_tags", flattenPackagesFirewallMulticastPolicy6CustomTags(o["custom-tags"], d, "custom_tags")); err != nil {
		if vv, ok := fortiAPIPatch(o["custom-tags"], "PackagesFirewallMulticastPolicy6-CustomTags"); ok {
	...
	if err = d.Set("ips_sensor", flattenPackagesFirewallMulticastPolicy6IpsSensor(o["ips-sensor"], d, "ips_sensor")); err != nil {
		if vv, ok := fortiAPIPatch(o["ips-sensor"], "PackagesFirewallMulticastPolicy6-IpsSensor"); ok {
	...
	if err = d.Set("utm_status", flattenPackagesFirewallMulticastPolicy6UtmStatus(o["utm-status"], d, "utm_status")); err != nil {
		if vv, ok := fortiAPIPatch(o["utm-status"], "PackagesFirewallMulticastPolicy6-UtmStatus"); ok {
...
func expandPackagesFirewallMulticastPolicy6CustomTags(d *schema.ResourceData, v interface{}, pre string) (interface{}, error) {
...
func expandPackagesFirewallMulticastPolicy6UtmStatus(d *schema.ResourceData, v interface{}, pre string) (interface{}, error) {
	return v, nil
}
...
func getObjectPackagesFirewallMulticastPolicy6(d *schema.ResourceData) (*map[string]interface{}, error) {
	...
	if v, ok := d.GetOk("custom_tags"); ok || d.HasChange("custom_tags") {
		t, err := expandPackagesFirewallMulticastPolicy6CustomTags(d, v, "custom_tags")
		if err != nil {
			return &obj, err
		} else if t != nil {
			obj["custom-tags"] = t
	...
	if v, ok := d.GetOk("ips_sensor"); ok || d.HasChange("ips_sensor") {
		t, err := expandPackagesFirewallMulticastPolicy6IpsSensor(d, v, "ips_sensor")
		if err != nil {
			return &obj, err
		} else if t != nil {
			obj["ips-sensor"] = t
	...
	if v, ok := d.GetOk("utm_status"); ok || d.HasChange("utm_status") {
		t, err := expandPackagesFirewallMulticastPolicy6UtmStatus(d, v, "utm_status")
		if err != nil {
			return &obj, err
		} else if t != nil {
			obj["utm-status"] = t
