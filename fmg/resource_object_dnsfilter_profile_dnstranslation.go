...
func resourceObjectDnsfilterProfileDnsTranslationCreate(d *schema.ResourceData, m interface{}) error {
	...
	if update_if_exist && mkey_ok {
		...
		if err == nil && o != nil {
			existing = true
			// update if existing
			o, err = c.UpdateObjectDnsfilterProfileDnsTranslation(obj, mkey, paradict, wsParams)
			if err != nil {
	...
	if !existing {
		_, err = c.CreateObjectDnsfilterProfileDnsTranslation(obj, paradict, wsParams)
		if err != nil {
...
func resourceObjectDnsfilterProfileDnsTranslationUpdate(d *schema.ResourceData, m interface{}) error {
	...
	_, err = c.UpdateObjectDnsfilterProfileDnsTranslation(obj, mkey, paradict, wsParams)
	if err != nil {
		return fmt.Errorf("Error updating ObjectDnsfilterProfileDnsTranslation resource: %v", err)
	}
...
func resourceObjectDnsfilterProfileDnsTranslationDelete(d *schema.ResourceData, m interface{}) error {
	...
	err = c.DeleteObjectDnsfilterProfileDnsTranslation(mkey, paradict, wsParams)
	if err != nil {
