...
func resourcePackagesFirewallHyperscalePolicy46Create(d *schema.ResourceData, m interface{}) error {
	...
	if update_if_exist && mkey_ok {
		...
		if err == nil && o != nil {
			existing = true
			// update if existing
			o, err = c.UpdatePackagesFirewallHyperscalePolicy46(obj, mkey, paradict, wsParams)
			if err != nil {
	...
	if !existing {
		_, err = c.CreatePackagesFirewallHyperscalePolicy46(obj, paradict, wsParams)
		if err != nil {
...
func resourcePackagesFirewallHyperscalePolicy46Update(d *schema.ResourceData, m interface{}) error {
	...
	_, err = c.UpdatePackagesFirewallHyperscalePolicy46(obj, mkey, paradict, wsParams)
	if err != nil {
		return fmt.Errorf("Error updating PackagesFirewallHyperscalePolicy46 resource: %v", err)
	}
...
func resourcePackagesFirewallHyperscalePolicy46Delete(d *schema.ResourceData, m interface{}) error {
	...
	err = c.DeletePackagesFirewallHyperscalePolicy46(mkey, paradict, wsParams)
	if err != nil {
