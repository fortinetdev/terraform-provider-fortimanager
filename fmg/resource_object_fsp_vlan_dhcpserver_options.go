...
func resourceObjectFspVlanDhcpServerOptionsCreate(d *schema.ResourceData, m interface{}) error {
	...
	if update_if_exist && mkey_ok {
		...
		if err == nil && o != nil {
			existing = true
			// update if existing
			o, err = c.UpdateObjectFspVlanDhcpServerOptions(obj, mkey, paradict, wsParams)
			if err != nil {
	...
	if !existing {
		_, err = c.CreateObjectFspVlanDhcpServerOptions(obj, paradict, wsParams)
		if err != nil {
...
func resourceObjectFspVlanDhcpServerOptionsUpdate(d *schema.ResourceData, m interface{}) error {
	...
	_, err = c.UpdateObjectFspVlanDhcpServerOptions(obj, mkey, paradict, wsParams)
	if err != nil {
		return fmt.Errorf("Error updating ObjectFspVlanDhcpServerOptions resource: %v", err)
	}
...
func resourceObjectFspVlanDhcpServerOptionsDelete(d *schema.ResourceData, m interface{}) error {
	...
	err = c.DeleteObjectFspVlanDhcpServerOptions(mkey, paradict, wsParams)
	if err != nil {
