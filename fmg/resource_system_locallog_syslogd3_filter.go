...
func resourceSystemLocallogSyslogd3FilterUpdate(d *schema.ResourceData, m interface{}) error {
	...
	obj, err := getObjectSystemLocallogSyslogd3Filter(d, false)
	if err != nil {
...
func resourceSystemLocallogSyslogd3FilterDelete(d *schema.ResourceData, m interface{}) error {
	...
	obj, err := getObjectSystemLocallogSyslogd3Filter(d, true)
	...
	_, err = c.UpdateSystemLocallogSyslogd3Filter(obj, mkey, paradict, wsParams)
	if err != nil {
		return fmt.Errorf("Error clearing SystemLocallogSyslogd3Filter resource: %v", err)
	}
...
func getObjectSystemLocallogSyslogd3Filter(d *schema.ResourceData, bemptysontable bool) (*map[string]interface{}, error) {
