...
func resourceObjectCloudOrchestAwstemplateAutoscaleExistingVpcCreate(d *schema.ResourceData, m interface{}) error {
	...
	_, err = c.CreateObjectCloudOrchestAwstemplateAutoscaleExistingVpc(obj, paradict)
...
func resourceObjectCloudOrchestAwstemplateAutoscaleExistingVpcUpdate(d *schema.ResourceData, m interface{}) error {
	...
	_, err = c.UpdateObjectCloudOrchestAwstemplateAutoscaleExistingVpc(obj, mkey, paradict)
	if err != nil {
...
func resourceObjectCloudOrchestAwstemplateAutoscaleExistingVpcDelete(d *schema.ResourceData, m interface{}) error {
	...
	err = c.DeleteObjectCloudOrchestAwstemplateAutoscaleExistingVpc(mkey, paradict)
	if err != nil {
...
func flattenObjectCloudOrchestAwstemplateAutoscaleExistingVpcFazAutoscaleAdminPassword(v interface{}, d *schema.ResourceData, pre string) interface{} {
...
func refreshObjectObjectCloudOrchestAwstemplateAutoscaleExistingVpc(d *schema.ResourceData, o map[string]interface{}) error {
	...
	if err = d.Set("faz_autoscale_admin_password", flattenObjectCloudOrchestAwstemplateAutoscaleExistingVpcFazAutoscaleAdminPassword(o["faz-autoscale-admin-password"], d, "faz_autoscale_admin_password")); err != nil {
		if vv, ok := fortiAPIPatch(o["faz-autoscale-admin-password"], "ObjectCloudOrchestAwstemplateAutoscaleExistingVpc-FazAutoscaleAdminPassword"); ok {
