...
func resourcePackagesFirewallMulticastPolicySort() *schema.Resource {
	return &schema.Resource{
		Create: resourcePackagesFirewallMulticastPolicySortCreateUpdate,
		Read:   resourcePackagesFirewallMulticastPolicySortRead,
		Update: resourcePackagesFirewallMulticastPolicySortCreateUpdate,
		Delete: schema.Noop,
...
func resourcePackagesFirewallMulticastPolicySortCreateUpdate(d *schema.ResourceData, m interface{}) (err error) {
	...
	err = c.CreateUpdatePackagesFirewallMulticastPolicySort(&input_model)
	if err != nil {
		return fmt.Errorf("Error sorting PackagesFirewallMulticastPolicy: %s", err)
	}

	d.SetId(sortby + sortdirection)

	return resourcePackagesFirewallMulticastPolicySortRead(d, m)
}

func resourcePackagesFirewallMulticastPolicySortRead(d *schema.ResourceData, m interface{}) error {
	mkey := d.Id()
	...
	sorted, o, err := c.ReadPackagesFirewallMulticastPolicySort(&input_model)
	if err != nil {
		return fmt.Errorf("Error reading PackagesFirewallMulticastPolicy sort status: %s %s", err, mkey)
	}
	...
	if o != nil {
		if err := d.Set("state_list", o); err != nil {
			log.Printf("[WARN] Error reading PackagesFirewallMulticastPolicy List for (%s): %s", d.Id(), err)
		}
	} else {
