...
func resourceObjectAntivirusProfilePop3Update(d *schema.ResourceData, m interface{}) error {
	...
	obj, err := getObjectObjectAntivirusProfilePop3(d, false)
	if err != nil {
...
func resourceObjectAntivirusProfilePop3Delete(d *schema.ResourceData, m interface{}) error {
	...
	obj, err := getObjectObjectAntivirusProfilePop3(d, true)
	...
	_, err = c.UpdateObjectAntivirusProfilePop3(obj, mkey, paradict, wsParams)
	if err != nil {
		return fmt.Errorf("Error clearing ObjectAntivirusProfilePop3 resource: %v", err)
	}
...
func getObjectObjectAntivirusProfilePop3(d *schema.ResourceData, bemptysontable bool) (*map[string]interface{}, error) {
