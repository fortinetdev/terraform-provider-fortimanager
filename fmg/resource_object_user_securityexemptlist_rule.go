...
func resourceObjectUserSecurityExemptListRuleCreate(d *schema.ResourceData, m interface{}) error {
	...
	if update_if_exist && mkey_ok {
		...
		if err == nil && o != nil {
			existing = true
			// update if existing
			o, err = c.UpdateObjectUserSecurityExemptListRule(obj, mkey, paradict, wsParams)
			if err != nil {
	...
	if !existing {
		_, err = c.CreateObjectUserSecurityExemptListRule(obj, paradict, wsParams)
		if err != nil {
...
func resourceObjectUserSecurityExemptListRuleUpdate(d *schema.ResourceData, m interface{}) error {
	...
	_, err = c.UpdateObjectUserSecurityExemptListRule(obj, mkey, paradict, wsParams)
	if err != nil {
		return fmt.Errorf("Error updating ObjectUserSecurityExemptListRule resource: %v", err)
	}
...
func resourceObjectUserSecurityExemptListRuleDelete(d *schema.ResourceData, m interface{}) error {
	...
	err = c.DeleteObjectUserSecurityExemptListRule(mkey, paradict, wsParams)
	if err != nil {
