...
func resourceObjectWirelessControllerBonjourProfilePolicyListSort() *schema.Resource {
	return &schema.Resource{
		Create: resourceObjectWirelessControllerBonjourProfilePolicyListSortCreateUpdate,
		Read:   resourceObjectWirelessControllerBonjourProfilePolicyListSortRead,
		Update: resourceObjectWirelessControllerBonjourProfilePolicyListSortCreateUpdate,
		Delete: schema.Noop,
...
func resourceObjectWirelessControllerBonjourProfilePolicyListSortCreateUpdate(d *schema.ResourceData, m interface{}) (err error) {
	...
	err = c.CreateUpdateObjectWirelessControllerBonjourProfilePolicyListSort(&input_model)
	if err != nil {
		return fmt.Errorf("Error sorting ObjectWirelessControllerBonjourProfilePolicyList: %s", err)
	}

	d.SetId(sortby + sortdirection)

	return resourceObjectWirelessControllerBonjourProfilePolicyListSortRead(d, m)
}

func resourceObjectWirelessControllerBonjourProfilePolicyListSortRead(d *schema.ResourceData, m interface{}) error {
	mkey := d.Id()
	...
	sorted, o, err := c.ReadObjectWirelessControllerBonjourProfilePolicyListSort(&input_model)
	if err != nil {
		return fmt.Errorf("Error reading ObjectWirelessControllerBonjourProfilePolicyList sort status: %s %s", err, mkey)
	}
	...
	if o != nil {
		if err := d.Set("state_list", o); err != nil {
			log.Printf("[WARN] Error reading ObjectWirelessControllerBonjourProfilePolicyList List for (%s): %s", d.Id(), err)
		}
	} else {
