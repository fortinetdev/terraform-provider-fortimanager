...
func resourcePackagesFirewallInterfacePolicySort() *schema.Resource {
	return &schema.Resource{
		Create: resourcePackagesFirewallInterfacePolicySortCreateUpdate,
		Read:   resourcePackagesFirewallInterfacePolicySortRead,
		Update: resourcePackagesFirewallInterfacePolicySortCreateUpdate,
		Delete: schema.Noop,
...
func resourcePackagesFirewallInterfacePolicySortCreateUpdate(d *schema.ResourceData, m interface{}) (err error) {
	...
	err = c.CreateUpdatePackagesFirewallInterfacePolicySort(&input_model)
	if err != nil {
		return fmt.Errorf("Error sorting PackagesFirewallInterfacePolicy: %s", err)
	}

	d.SetId(sortby + sortdirection)

	return resourcePackagesFirewallInterfacePolicySortRead(d, m)
}

func resourcePackagesFirewallInterfacePolicySortRead(d *schema.ResourceData, m interface{}) error {
	mkey := d.Id()
	...
	sorted, o, err := c.ReadPackagesFirewallInterfacePolicySort(&input_model)
	if err != nil {
		return fmt.Errorf("Error reading PackagesFirewallInterfacePolicy sort status: %s %s", err, mkey)
	}
	...
	if o != nil {
		if err := d.Set("state_list", o); err != nil {
			log.Printf("[WARN] Error reading PackagesFirewallInterfacePolicy List for (%s): %s", d.Id(), err)
		}
	} else {
