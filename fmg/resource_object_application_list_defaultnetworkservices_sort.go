...
func resourceObjectApplicationListDefaultNetworkServicesSort() *schema.Resource {
	return &schema.Resource{
		Create: resourceObjectApplicationListDefaultNetworkServicesSortCreateUpdate,
		Read:   resourceObjectApplicationListDefaultNetworkServicesSortRead,
		Update: resourceObjectApplicationListDefaultNetworkServicesSortCreateUpdate,
		Delete: schema.Noop,
...
func resourceObjectApplicationListDefaultNetworkServicesSortCreateUpdate(d *schema.ResourceData, m interface{}) (err error) {
	...
	err = c.CreateUpdateObjectApplicationListDefaultNetworkServicesSort(&input_model)
	if err != nil {
		return fmt.Errorf("Error sorting ObjectApplicationListDefaultNetworkServices: %s", err)
	}

	d.SetId(sortby + sortdirection)

	return resourceObjectApplicationListDefaultNetworkServicesSortRead(d, m)
}

func resourceObjectApplicationListDefaultNetworkServicesSortRead(d *schema.ResourceData, m interface{}) error {
	mkey := d.Id()
	...
	sorted, o, err := c.ReadObjectApplicationListDefaultNetworkServicesSort(&input_model)
	if err != nil {
		return fmt.Errorf("Error reading ObjectApplicationListDefaultNetworkServices sort status: %s %s", err, mkey)
	}
	...
	if o != nil {
		if err := d.Set("state_list", o); err != nil {
			log.Printf("[WARN] Error reading ObjectApplicationListDefaultNetworkServices List for (%s): %s", d.Id(), err)
		}
	} else {
