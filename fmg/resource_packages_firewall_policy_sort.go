...
func resourcePackagesFirewallPolicySort() *schema.Resource {
	return &schema.Resource{
		Create: resourcePackagesFirewallPolicySortCreateUpdate,
		Read:   resourcePackagesFirewallPolicySortRead,
		Update: resourcePackagesFirewallPolicySortCreateUpdate,
		Delete: schema.Noop,
...
func resourcePackagesFirewallPolicySortCreateUpdate(d *schema.ResourceData, m interface{}) (err error) {
	...
	err = c.CreateUpdatePackagesFirewallPolicySort(&input_model)
	if err != nil {
		return fmt.Errorf("Error sorting PackagesFirewallPolicy: %s", err)
	}

	d.SetId(sortby + sortdirection)

	return resourcePackagesFirewallPolicySortRead(d, m)
}

func resourcePackagesFirewallPolicySortRead(d *schema.ResourceData, m interface{}) error {
	mkey := d.Id()
	...
	sorted, o, err := c.ReadPackagesFirewallPolicySort(&input_model)
	if err != nil {
		return fmt.Errorf("Error reading PackagesFirewallPolicy sort status: %s %s", err, mkey)
	}
	...
	if o != nil {
		if err := d.Set("state_list", o); err != nil {
			log.Printf("[WARN] Error reading PackagesFirewallPolicy List for (%s): %s", d.Id(), err)
		}
	} else {
