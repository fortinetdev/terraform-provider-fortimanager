...
func resourceObjectZtnaWebPortalBookmarkBookmarksSort() *schema.Resource {
	return &schema.Resource{
		Create: resourceObjectZtnaWebPortalBookmarkBookmarksSortCreateUpdate,
		Read:   resourceObjectZtnaWebPortalBookmarkBookmarksSortRead,
		Update: resourceObjectZtnaWebPortalBookmarkBookmarksSortCreateUpdate,
		Delete: schema.Noop,
...
func resourceObjectZtnaWebPortalBookmarkBookmarksSortCreateUpdate(d *schema.ResourceData, m interface{}) (err error) {
	...
	err = c.CreateUpdateObjectZtnaWebPortalBookmarkBookmarksSort(&input_model)
	if err != nil {
		return fmt.Errorf("Error sorting ObjectZtnaWebPortalBookmarkBookmarks: %s", err)
	}

	d.SetId(sortby + sortdirection)

	return resourceObjectZtnaWebPortalBookmarkBookmarksSortRead(d, m)
}

func resourceObjectZtnaWebPortalBookmarkBookmarksSortRead(d *schema.ResourceData, m interface{}) error {
	mkey := d.Id()
	...
	sorted, o, err := c.ReadObjectZtnaWebPortalBookmarkBookmarksSort(&input_model)
	if err != nil {
		return fmt.Errorf("Error reading ObjectZtnaWebPortalBookmarkBookmarks sort status: %s %s", err, mkey)
	}
	...
	if o != nil {
		if err := d.Set("state_list", o); err != nil {
			log.Printf("[WARN] Error reading ObjectZtnaWebPortalBookmarkBookmarks List for (%s): %s", d.Id(), err)
		}
	} else {
