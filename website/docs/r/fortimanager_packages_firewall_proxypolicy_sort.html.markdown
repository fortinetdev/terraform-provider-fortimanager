...
layout: "fortimanager"
page_title: "FortiManager: fortimanager_packages_firewall_proxypolicy_sort"
description: |-
  Sort for packages firewall_proxy-policy.
---

# fortimanager_packages_firewall_proxypolicy_sort
Sort for packages firewall_proxy-policy.

```hcl
resource "fortimanager_packages_firewall_proxypolicy_sort" "test" {
	sortby        = "policyid"
