...
layout: "fortimanager"
page_title: "FortiManager: fortimanager_packages_firewall_localinpolicy_sort"
description: |-
  Sort for packages firewall_local-in-policy.
---

# fortimanager_packages_firewall_localinpolicy_sort
Sort for packages firewall_local-in-policy.

```hcl
resource "fortimanager_packages_firewall_localinpolicy_sort" "test" {
	sortby        = "policyid"
