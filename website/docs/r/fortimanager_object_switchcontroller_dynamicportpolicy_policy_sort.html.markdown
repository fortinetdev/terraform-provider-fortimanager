...
layout: "fortimanager"
page_title: "FortiManager: fortimanager_object_switchcontroller_dynamicportpolicy_policy_sort"
description: |-
  Sort for object_switch-controller dynamic-port-policy_policy.
---

# fortimanager_object_switchcontroller_dynamicportpolicy_policy_sort
Sort for object_switch-controller dynamic-port-policy_policy.

```hcl
resource "fortimanager_object_switchcontroller_dynamicportpolicy_policy_sort" "test" {
	sortby        = "name"
