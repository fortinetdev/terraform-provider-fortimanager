...
layout: "fortimanager"
page_title: "FortiManager: fortimanager_object_wirelesscontroller_accesscontrollist_layer3ipv4rules_sort"
description: |-
  Sort for object_wireless-controller access-control-list_layer3-ipv4-rules.
---

# fortimanager_object_wirelesscontroller_accesscontrollist_layer3ipv4rules_sort
Sort for object_wireless-controller access-control-list_layer3-ipv4-rules.

```hcl
resource "fortimanager_object_wirelesscontroller_accesscontrollist_layer3ipv4rules_sort" "test" {
	sortby        = "rule-id"
