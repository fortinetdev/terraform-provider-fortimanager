...
layout: "fortimanager"
page_title: "FortiManager: fortimanager_object_vpn_ipsec_fec_mappings_tos_sort"
description: |-
  Sort for object_vpn ipsec_fec_mappings_tos.
---

# fortimanager_object_vpn_ipsec_fec_mappings_tos_sort
Sort for object_vpn ipsec_fec_mappings_tos.

```hcl
resource "fortimanager_object_vpn_ipsec_fec_mappings_tos_sort" "test" {
	sortby        = "seqno"
