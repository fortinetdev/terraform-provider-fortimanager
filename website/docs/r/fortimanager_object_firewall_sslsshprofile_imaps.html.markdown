...
~> This resource is a sub resource for variable `imaps` of resource `fortimanager_object_firewall_sslsshprofile`. Conflict and overwrite may occur if use both of them.
...
```hcl
resource "fortimanager_object_firewall_sslsshprofile_imaps" "trname" {
