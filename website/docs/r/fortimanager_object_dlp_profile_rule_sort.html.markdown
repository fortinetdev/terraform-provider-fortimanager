...
layout: "fortimanager"
page_title: "FortiManager: fortimanager_object_dlp_profile_rule_sort"
description: |-
  Sort for object_dlp profile_rule.
---

# fortimanager_object_dlp_profile_rule_sort
Sort for object_dlp profile_rule.

```hcl
resource "fortimanager_object_dlp_profile_rule_sort" "test" {
	sortby        = "id"
