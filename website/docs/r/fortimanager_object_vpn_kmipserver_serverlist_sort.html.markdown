...
layout: "fortimanager"
page_title: "FortiManager: fortimanager_object_vpn_kmipserver_serverlist_sort"
description: |-
  Sort for object_vpn kmip-server_server-list.
---

# fortimanager_object_vpn_kmipserver_serverlist_sort
Sort for object_vpn kmip-server_server-list.

```hcl
resource "fortimanager_object_vpn_kmipserver_serverlist_sort" "test" {
	sortby        = "id"
