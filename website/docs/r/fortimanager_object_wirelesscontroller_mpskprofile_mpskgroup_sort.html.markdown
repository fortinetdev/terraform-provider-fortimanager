...
layout: "fortimanager"
page_title: "FortiManager: fortimanager_object_wirelesscontroller_mpskprofile_mpskgroup_sort"
description: |-
  Sort for object_wireless-controller mpsk-profile_mpsk-group.
---

# fortimanager_object_wirelesscontroller_mpskprofile_mpskgroup_sort
Sort for object_wireless-controller mpsk-profile_mpsk-group.

```hcl
resource "fortimanager_object_wirelesscontroller_mpskprofile_mpskgroup_sort" "test" {
	sortby        = "name"
