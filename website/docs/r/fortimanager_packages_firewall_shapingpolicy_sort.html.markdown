...
layout: "fortimanager"
page_title: "FortiManager: fortimanager_packages_firewall_shapingpolicy_sort"
description: |-
  Sort for packages firewall_shaping-policy.
---

# fortimanager_packages_firewall_shapingpolicy_sort
Sort for packages firewall_shaping-policy.

```hcl
resource "fortimanager_packages_firewall_shapingpolicy_sort" "test" {
	sortby        = "id"
