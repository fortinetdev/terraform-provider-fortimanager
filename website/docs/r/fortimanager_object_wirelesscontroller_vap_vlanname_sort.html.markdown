...
layout: "fortimanager"
page_title: "FortiManager: fortimanager_object_wirelesscontroller_vap_vlanname_sort"
description: |-
  Sort for object_wireless-controller vap_vlan-name.
---

# fortimanager_object_wirelesscontroller_vap_vlanname_sort
Sort for object_wireless-controller vap_vlan-name.

```hcl
resource "fortimanager_object_wirelesscontroller_vap_vlanname_sort" "test" {
	sortby        = "name"
