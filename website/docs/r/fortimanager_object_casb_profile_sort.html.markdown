...
layout: "fortimanager"
page_title: "FortiManager: fortimanager_object_casb_profile_sort"
description: |-
  Sort for object_casb profile.
---

# fortimanager_object_casb_profile_sort
Sort for object_casb profile.

```hcl
resource "fortimanager_object_casb_profile_sort" "test" {
	sortby        = "name"
