...
layout: "fortimanager"
page_title: "FortiManager: fortimanager_object_fsp_vlan_dhcpserver_reservedaddress"
description: |-
...
~> This resource is a sub resource for variable `reserved_address` of resource `fortimanager_object_fsp_vlan_dhcpserver`. Conflict and overwrite may occur if use both of them.
...
$ terraform import fortimanager_object_fsp_vlan_dhcpserver_reservedaddress.labelname {{fosid}}
