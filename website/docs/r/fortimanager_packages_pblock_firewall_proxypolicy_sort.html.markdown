...
layout: "fortimanager"
page_title: "FortiManager: fortimanager_packages_pblock_firewall_proxypolicy_sort"
description: |-
  Sort for packages pblock_firewall_proxy-policy.
---

# fortimanager_packages_pblock_firewall_proxypolicy_sort
Sort for packages pblock_firewall_proxy-policy.

```hcl
resource "fortimanager_packages_pblock_firewall_proxypolicy_sort" "test" {
	sortby        = "name"
