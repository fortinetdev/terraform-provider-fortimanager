...
layout: "fortimanager"
page_title: "FortiManager: fortimanager_object_firewall_shapingprofile_classes_sort"
description: |-
  Sort for object_firewall shaping-profile_classes.
---

# fortimanager_object_firewall_shapingprofile_classes_sort
Sort for object_firewall shaping-profile_classes.

```hcl
resource "fortimanager_object_firewall_shapingprofile_classes_sort" "test" {
	sortby        = "name"
