...
subcategory: "Wantemp"
layout: "fortimanager"
page_title: "FortiManager: fortimanager_wantemp_system_sdwan_service_sort"
description: |-
  Sort for wantemp system_sdwan_service.
---

# fortimanager_wantemp_system_sdwan_service_sort
Sort for wantemp system_sdwan_service.

```hcl
resource "fortimanager_wantemp_system_sdwan_service_sort" "test" {
	sortby        = "id"
