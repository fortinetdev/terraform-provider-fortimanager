...
layout: "fortimanager"
page_title: "FortiManager: fortimanager_packages_firewall_multicastpolicy_sort"
description: |-
  Sort for packages firewall_multicast-policy.
---

# fortimanager_packages_firewall_multicastpolicy_sort
Sort for packages firewall_multicast-policy.

```hcl
resource "fortimanager_packages_firewall_multicastpolicy_sort" "test" {
	sortby        = "id"
