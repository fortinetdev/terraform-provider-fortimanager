...
---
subcategory: "Object File Filter"
layout: "fortimanager"
page_title: "FortiManager: fortimanager_object_filefilter_profile_rules_sort"
description: |-
  Sort for object_file-filter profile_rules.
---

# fortimanager_object_filefilter_profile_rules_sort
Sort for object_file-filter profile_rules.

```hcl
resource "fortimanager_object_filefilter_profile_rules_sort" "test" {
	sortby        = "name"
