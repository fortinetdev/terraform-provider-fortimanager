...
layout: "fortimanager"
page_title: "FortiManager: fortimanager_packages_firewall_policy_sort"
description: |-
  Sort for packages firewall_policy.
---

# fortimanager_packages_firewall_policy_sort
Sort for packages firewall_policy.

```hcl
resource "fortimanager_packages_firewall_policy_sort" "test" {
	sortby        = "policyid"
