...
layout: "fortimanager"
page_title: "FortiManager: fortimanager_object_system_replacemsggroup_ftp"
description: |-
...
~> This resource is a sub resource for variable `ftp` of resource `fortimanager_object_system_replacemsggroup`. Conflict and overwrite may occur if use both of them.
...
```hcl
resource "fortimanager_object_system_replacemsggroup_ftp" "trname" {
...
$ terraform import fortimanager_object_system_replacemsggroup_ftp.labelname {{msg_type}}
