...
---
subcategory: "Object DNS Filter"
layout: "fortimanager"
page_title: "FortiManager: fortimanager_object_dnsfilter_domainfilter_entries_sort"
description: |-
  Sort for object_dnsfilter domain-filter_entries.
---

# fortimanager_object_dnsfilter_domainfilter_entries_sort
Sort for object_dnsfilter domain-filter_entries.

```hcl
resource "fortimanager_object_dnsfilter_domainfilter_entries_sort" "test" {
	sortby        = "id"
