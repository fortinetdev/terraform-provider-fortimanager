...
layout: "fortimanager"
page_title: "FortiManager: fortimanager_object_system_sdnconnector_compartmentlist_sort"
description: |-
  Sort for object_system sdn-connector_compartment-list.
---

# fortimanager_object_system_sdnconnector_compartmentlist_sort
Sort for object_system sdn-connector_compartment-list.

```hcl
resource "fortimanager_object_system_sdnconnector_compartmentlist_sort" "test" {
