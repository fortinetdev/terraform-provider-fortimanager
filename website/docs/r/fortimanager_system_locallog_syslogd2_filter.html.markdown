...
layout: "fortimanager"
page_title: "FortiManager: fortimanager_system_locallog_syslogd2_filter"
description: |-
...
```hcl
resource "fortimanager_system_locallog_syslogd2_filter" "trname" {
  fgfm  = "enable"
  lrmgr = "enable"
}
```
...
$ terraform import fortimanager_system_locallog_syslogd2_filter.labelname SystemLocallogSyslogd2Filter
