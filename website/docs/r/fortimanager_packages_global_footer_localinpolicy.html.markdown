...
layout: "fortimanager"
page_title: "FortiManager: fortimanager_packages_global_footer_localinpolicy"
description: |-
  Configure user defined IPv4 local-in policies.
---

# fortimanager_packages_global_footer_localinpolicy
Configure user defined IPv4 local-in policies.
...
$ terraform import fortimanager_packages_global_footer_localinpolicy.labelname {{policyid}}
