...
layout: "fortimanager"
page_title: "FortiManager: fortimanager_object_system_sdnconnector_ociregionlist_sort"
description: |-
  Sort for object_system sdn-connector_oci-region-list.
---

# fortimanager_object_system_sdnconnector_ociregionlist_sort
Sort for object_system sdn-connector_oci-region-list.

```hcl
resource "fortimanager_object_system_sdnconnector_ociregionlist_sort" "test" {
	sortby        = "region"
