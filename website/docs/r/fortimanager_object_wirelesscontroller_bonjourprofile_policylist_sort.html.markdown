...
layout: "fortimanager"
page_title: "FortiManager: fortimanager_object_wirelesscontroller_bonjourprofile_policylist_sort"
description: |-
  Sort for object_wireless-controller bonjour-profile_policy-list.
---

# fortimanager_object_wirelesscontroller_bonjourprofile_policylist_sort
Sort for object_wireless-controller bonjour-profile_policy-list.

```hcl
resource "fortimanager_object_wirelesscontroller_bonjourprofile_policylist_sort" "test" {
	sortby        = "policy-id"
