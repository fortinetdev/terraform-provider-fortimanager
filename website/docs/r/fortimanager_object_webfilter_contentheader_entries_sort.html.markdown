...
layout: "fortimanager"
page_title: "FortiManager: fortimanager_object_webfilter_contentheader_entries_sort"
description: |-
  Sort for object_webfilter content-header_entries.
---

# fortimanager_object_webfilter_contentheader_entries_sort
Sort for object_webfilter content-header_entries.

```hcl
resource "fortimanager_object_webfilter_contentheader_entries_sort" "test" {
	sortby        = "pattern"
