...
layout: "fortimanager"
page_title: "FortiManager: fortimanager_packages_firewall_centralsnatmap_sort"
description: |-
  Sort for packages firewall_central-snat-map.
---

# fortimanager_packages_firewall_centralsnatmap_sort
Sort for packages firewall_central-snat-map.

```hcl
resource "fortimanager_packages_firewall_centralsnatmap_sort" "test" {
	sortby        = "policyid"
