...
* `name` - Profile name.
* `sccp` - Sccp. The structure of `sccp` block is documented below. (`ver FortiManager >= 7.0 and Controlled FortiOS >= 6.4`)
* `sip` - Sip. The structure of `sip` block is documented below. (`ver FortiManager >= 7.0 and Controlled FortiOS >= 6.4`)

The `sccp` block supports (`ver FortiManager >= 7.0 and Controlled FortiOS >= 6.4`):
...
The `sip` block supports (`ver FortiManager >= 7.0 and Controlled FortiOS >= 6.4`):
