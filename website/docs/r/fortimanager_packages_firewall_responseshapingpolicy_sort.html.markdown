...
layout: "fortimanager"
page_title: "FortiManager: fortimanager_packages_firewall_responseshapingpolicy_sort"
description: |-
  Sort for packages firewall_response-shaping-policy.
---

# fortimanager_packages_firewall_responseshapingpolicy_sort
Sort for packages firewall_response-shaping-policy.

```hcl
resource "fortimanager_packages_firewall_responseshapingpolicy_sort" "test" {
	sortby        = "id"
