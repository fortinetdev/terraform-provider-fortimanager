...
layout: "fortimanager"
page_title: "FortiManager: fortimanager_object_webproxy_redirectprofile_entries_sort"
description: |-
  Sort for object_web-proxy redirect-profile_entries.
---

# fortimanager_object_webproxy_redirectprofile_entries_sort
Sort for object_web-proxy redirect-profile_entries.

```hcl
resource "fortimanager_object_webproxy_redirectprofile_entries_sort" "test" {
	sortby        = "id"
