...
layout: "fortimanager"
page_title: "FortiManager: fortimanager_packages_pblock_firewall_localinpolicy6_sort"
description: |-
  Sort for packages pblock_firewall_local-in-policy6.
---

# fortimanager_packages_pblock_firewall_localinpolicy6_sort
Sort for packages pblock_firewall_local-in-policy6.

```hcl
resource "fortimanager_packages_pblock_firewall_localinpolicy6_sort" "test" {
	sortby        = "policyid"
