...
layout: "fortimanager"
page_title: "FortiManager: fortimanager_object_wirelesscontroller_mpskprofile_mpskgroup_mpskkey_sort"
description: |-
  Sort for object_wireless-controller mpsk-profile_mpsk-group_mpsk-key.
---

# fortimanager_object_wirelesscontroller_mpskprofile_mpskgroup_mpskkey_sort
Sort for object_wireless-controller mpsk-profile_mpsk-group_mpsk-key.

```hcl
resource "fortimanager_object_wirelesscontroller_mpskprofile_mpskgroup_mpskkey_sort" "test" {
	sortby        = "name"
