...
layout: "fortimanager"
page_title: "FortiManager: fortimanager_packages_firewall_DoSpolicy6_sort"
description: |-
  Sort for packages firewall_DoS-policy6.
---

# fortimanager_packages_firewall_DoSpolicy6_sort
Sort for packages firewall_DoS-policy6.

```hcl
resource "fortimanager_packages_firewall_DoSpolicy6_sort" "test" {
	sortby        = "policyid"
