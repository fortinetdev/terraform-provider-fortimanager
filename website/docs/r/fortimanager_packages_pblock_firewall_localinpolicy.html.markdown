...
layout: "fortimanager"
page_title: "FortiManager: fortimanager_packages_pblock_firewall_localinpolicy"
description: |-
  Configure user defined IPv4 local-in policies.
---

# fortimanager_packages_pblock_firewall_localinpolicy
Configure user defined IPv4 local-in policies.

~> This resource is a sub resource for variable `firewall_local_in_policy` of resource `fortimanager_packages_pblock`. Conflict and overwrite may occur if use both of them.
...
Packages PblockFirewallLocalInPolicy can be imported using any of these accepted formats:
```
Set import_options = ["pblock=YOUR_VALUE"] in the provider section.

$ export "FORTIMANAGER_IMPORT_TABLE"="true"
$ terraform import fortimanager_packages_pblock_firewall_localinpolicy.labelname {{policyid}}
