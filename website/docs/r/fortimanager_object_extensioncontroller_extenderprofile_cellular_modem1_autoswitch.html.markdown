...
layout: "fortimanager"
page_title: "FortiManager: fortimanager_object_extensioncontroller_extenderprofile_cellular_modem1_autoswitch"
description: |-
...
~> This resource is a sub resource for variable `auto_switch` of resource `fortimanager_object_extensioncontroller_extenderprofile_cellular_modem1`. Conflict and overwrite may occur if use both of them.
...
$ terraform import fortimanager_object_extensioncontroller_extenderprofile_cellular_modem1_autoswitch.labelname ObjectExtensionControllerExtenderProfileCellularModem1AutoSwitch
