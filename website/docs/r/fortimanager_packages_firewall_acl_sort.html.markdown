...
layout: "fortimanager"
page_title: "FortiManager: fortimanager_packages_firewall_acl_sort"
description: |-
  Sort for packages firewall_acl.
---

# fortimanager_packages_firewall_acl_sort
Sort for packages firewall_acl.

```hcl
resource "fortimanager_packages_firewall_acl_sort" "test" {
	sortby        = "policyid"
