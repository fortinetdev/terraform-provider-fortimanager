...
layout: "fortimanager"
page_title: "FortiManager: fortimanager_object_firewall_accessproxysshclientcert_sort"
description: |-
  Sort for object_firewall access-proxy-ssh-client-cert.
---

# fortimanager_object_firewall_accessproxysshclientcert_sort
Sort for object_firewall access-proxy-ssh-client-cert.

```hcl
resource "fortimanager_object_firewall_accessproxysshclientcert_sort" "test" {
	sortby        = "name"
