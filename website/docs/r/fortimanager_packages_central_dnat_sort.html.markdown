...
layout: "fortimanager"
page_title: "FortiManager: fortimanager_packages_central_dnat_sort"
description: |-
  Sort for packages central_dnat.
---

# fortimanager_packages_central_dnat_sort
Sort for packages central_dnat.

```hcl
resource "fortimanager_packages_central_dnat_sort" "test" {
	sortby        = "name"
