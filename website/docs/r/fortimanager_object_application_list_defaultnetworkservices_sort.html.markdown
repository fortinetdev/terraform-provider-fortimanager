...
layout: "fortimanager"
page_title: "FortiManager: fortimanager_object_application_list_defaultnetworkservices_sort"
description: |-
  Sort for object_application list_default-network-services.
---

# fortimanager_object_application_list_defaultnetworkservices_sort
Sort for object_application list_default-network-services.

```hcl
resource "fortimanager_object_application_list_defaultnetworkservices_sort" "test" {
	sortby        = "id"
