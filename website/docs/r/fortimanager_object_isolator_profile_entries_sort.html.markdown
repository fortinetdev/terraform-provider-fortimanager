...
layout: "fortimanager"
page_title: "FortiManager: fortimanager_object_isolator_profile_entries_sort"
description: |-
  Sort for object_isolator profile_entries.
---

# fortimanager_object_isolator_profile_entries_sort
Sort for object_isolator profile_entries.

```hcl
resource "fortimanager_object_isolator_profile_entries_sort" "test" {
	sortby        = "id"
