...
layout: "fortimanager"
page_title: "FortiManager: fortimanager_packages_user_nacpolicy_sort"
description: |-
  Sort for packages user_nac-policy.
---

# fortimanager_packages_user_nacpolicy_sort
Sort for packages user_nac-policy.

```hcl
resource "fortimanager_packages_user_nacpolicy_sort" "test" {
	sortby        = "name"
