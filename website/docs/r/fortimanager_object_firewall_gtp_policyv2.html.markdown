...
~> This resource is a sub resource for variable `policy_v2` of resource `fortimanager_object_firewall_gtp`. Conflict and overwrite may occur if use both of them.
