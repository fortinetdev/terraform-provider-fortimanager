...
layout: "fortimanager"
page_title: "FortiManager: fortimanager_packages_global_footer_localinpolicy6"
description: |-
  Configure user defined IPv6 local-in policies.
---

# fortimanager_packages_global_footer_localinpolicy6
Configure user defined IPv6 local-in policies.
...
$ terraform import fortimanager_packages_global_footer_localinpolicy6.labelname {{policyid}}
