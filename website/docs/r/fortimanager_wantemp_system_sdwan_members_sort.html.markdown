...
subcategory: "Wantemp"
layout: "fortimanager"
page_title: "FortiManager: fortimanager_wantemp_system_sdwan_members_sort"
description: |-
  Sort for wantemp system_sdwan_members.
---

# fortimanager_wantemp_system_sdwan_members_sort
Sort for wantemp system_sdwan_members.

```hcl
resource "fortimanager_wantemp_system_sdwan_members_sort" "test" {
	sortby        = "seq-num"
