...
layout: "fortimanager"
page_title: "FortiManager: fortimanager_object_application_list_entries_sort"
description: |-
  Sort for object_application list_entries.
---

# fortimanager_object_application_list_entries_sort
Sort for object_application list_entries.

```hcl
resource "fortimanager_object_application_list_entries_sort" "test" {
	sortby        = "id"
