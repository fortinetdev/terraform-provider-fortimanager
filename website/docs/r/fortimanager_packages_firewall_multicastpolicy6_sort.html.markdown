...
layout: "fortimanager"
page_title: "FortiManager: fortimanager_packages_firewall_multicastpolicy6_sort"
description: |-
  Sort for packages firewall_multicast-policy6.
---

# fortimanager_packages_firewall_multicastpolicy6_sort
Sort for packages firewall_multicast-policy6.

```hcl
resource "fortimanager_packages_firewall_multicastpolicy6_sort" "test" {
	sortby        = "id"
