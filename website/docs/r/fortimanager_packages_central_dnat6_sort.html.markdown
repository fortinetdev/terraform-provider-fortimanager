...
layout: "fortimanager"
page_title: "FortiManager: fortimanager_packages_central_dnat6_sort"
description: |-
  Sort for packages central_dnat6.
---

# fortimanager_packages_central_dnat6_sort
Sort for packages central_dnat6.

```hcl
resource "fortimanager_packages_central_dnat6_sort" "test" {
	sortby        = "name"
