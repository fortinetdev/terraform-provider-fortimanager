...
layout: "fortimanager"
page_title: "FortiManager: fortimanager_object_system_externalresource_sort"
description: |-
  Sort for object_system external-resource.
---

# fortimanager_object_system_externalresource_sort
Sort for object_system external-resource.

```hcl
resource "fortimanager_object_system_externalresource_sort" "test" {
	sortby        = "name"
