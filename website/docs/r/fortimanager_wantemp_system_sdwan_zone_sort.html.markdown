...
subcategory: "Wantemp"
layout: "fortimanager"
page_title: "FortiManager: fortimanager_wantemp_system_sdwan_zone_sort"
description: |-
  Sort for wantemp system_sdwan_zone.
---

# fortimanager_wantemp_system_sdwan_zone_sort
Sort for wantemp system_sdwan_zone.

```hcl
resource "fortimanager_wantemp_system_sdwan_zone_sort" "test" {
	sortby        = "name"
