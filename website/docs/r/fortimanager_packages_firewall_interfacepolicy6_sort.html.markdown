...
layout: "fortimanager"
page_title: "FortiManager: fortimanager_packages_firewall_interfacepolicy6_sort"
description: |-
  Sort for packages firewall_interface-policy6.
---

# fortimanager_packages_firewall_interfacepolicy6_sort
Sort for packages firewall_interface-policy6.

```hcl
resource "fortimanager_packages_firewall_interfacepolicy6_sort" "test" {
	sortby        = "policyid"
