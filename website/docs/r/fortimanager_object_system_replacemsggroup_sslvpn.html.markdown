...
layout: "fortimanager"
page_title: "FortiManager: fortimanager_object_system_replacemsggroup_sslvpn"
description: |-
...
~> This resource is a sub resource for variable `sslvpn` of resource `fortimanager_object_system_replacemsggroup`. Conflict and overwrite may occur if use both of them.
...
```hcl
resource "fortimanager_object_system_replacemsggroup_sslvpn" "trname" {
...
$ terraform import fortimanager_object_system_replacemsggroup_sslvpn.labelname {{msg_type}}
