...
layout: "fortimanager"
page_title: "FortiManager: fortimanager_packages_pblock_firewall_policy_sort"
description: |-
  Sort for packages pblock_firewall_policy.
---

# fortimanager_packages_pblock_firewall_policy_sort
Sort for packages pblock_firewall_policy.

```hcl
resource "fortimanager_packages_pblock_firewall_policy_sort" "test" {
	sortby        = "policyid"
