...
---
subcategory: "Object Email Filter"
layout: "fortimanager"
page_title: "FortiManager: fortimanager_object_emailfilter_blockallowlist_entries_sort"
description: |-
  Sort for object_emailfilter block-allow-list_entries.
---

# fortimanager_object_emailfilter_blockallowlist_entries_sort
Sort for object_emailfilter block-allow-list_entries.

```hcl
resource "fortimanager_object_emailfilter_blockallowlist_entries_sort" "test" {
	sortby        = "id"
