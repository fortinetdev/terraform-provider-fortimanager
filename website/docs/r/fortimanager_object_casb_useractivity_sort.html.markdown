...
layout: "fortimanager"
page_title: "FortiManager: fortimanager_object_casb_useractivity_sort"
description: |-
  Sort for object_casb user-activity.
---

# fortimanager_object_casb_useractivity_sort
Sort for object_casb user-activity.

```hcl
resource "fortimanager_object_casb_useractivity_sort" "test" {
	sortby        = "name"
