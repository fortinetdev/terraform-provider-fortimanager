...
layout: "fortimanager"
page_title: "FortiManager: fortimanager_object_dlp_dictionary_entries_sort"
description: |-
  Sort for object_dlp dictionary_entries.
---

# fortimanager_object_dlp_dictionary_entries_sort
Sort for object_dlp dictionary_entries.

```hcl
resource "fortimanager_object_dlp_dictionary_entries_sort" "test" {
	sortby        = "id"
