...
layout: "fortimanager"
page_title: "FortiManager: fortimanager_object_videofilter_profile_filters_sort"
description: |-
  Sort for object_videofilter profile_filters.
---

# fortimanager_object_videofilter_profile_filters_sort
Sort for object_videofilter profile_filters.

```hcl
resource "fortimanager_object_videofilter_profile_filters_sort" "test" {
	sortby        = "id"
