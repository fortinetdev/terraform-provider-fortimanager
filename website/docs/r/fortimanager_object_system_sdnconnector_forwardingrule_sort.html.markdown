...
layout: "fortimanager"
page_title: "FortiManager: fortimanager_object_system_sdnconnector_forwardingrule_sort"
description: |-
  Sort for object_system sdn-connector_forwarding-rule.
---

# fortimanager_object_system_sdnconnector_forwardingrule_sort
Sort for object_system sdn-connector_forwarding-rule.

```hcl
resource "fortimanager_object_system_sdnconnector_forwardingrule_sort" "test" {
	sortby        = "rule-name"
