...
layout: "fortimanager"
page_title: "FortiManager: fortimanager_object_ztna_webportalbookmark_bookmarks_sort"
description: |-
  Sort for object_ztna web-portal-bookmark_bookmarks.
---

# fortimanager_object_ztna_webportalbookmark_bookmarks_sort
Sort for object_ztna web-portal-bookmark_bookmarks.

```hcl
resource "fortimanager_object_ztna_webportalbookmark_bookmarks_sort" "test" {
	sortby        = "name"
