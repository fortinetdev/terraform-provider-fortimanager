...
layout: "fortimanager"
page_title: "FortiManager: fortimanager_object_firewall_vip6_sslserverciphersuites"
description: |-
  SSL/TLS cipher suites to offer to a server, ordered by priority.
---

# fortimanager_object_firewall_vip6_sslserverciphersuites
SSL/TLS cipher suites to offer to a server, ordered by priority.

~> This resource is a sub resource for variable `ssl_server_cipher_suites` of resource `fortimanager_object_firewall_vip6`. Conflict and overwrite may occur if use both of them.
...
$ terraform import fortimanager_object_firewall_vip6_sslserverciphersuites.labelname {{priority}}
