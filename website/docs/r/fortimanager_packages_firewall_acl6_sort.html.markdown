...
layout: "fortimanager"
page_title: "FortiManager: fortimanager_packages_firewall_acl6_sort"
description: |-
  Sort for packages firewall_acl6.
---

# fortimanager_packages_firewall_acl6_sort
Sort for packages firewall_acl6.

```hcl
resource "fortimanager_packages_firewall_acl6_sort" "test" {
	sortby        = "policyid"
