...
layout: "fortimanager"
page_title: "FortiManager: fortimanager_object_webfilter_urlfilter_entries_sort"
description: |-
  Sort for object_webfilter urlfilter_entries.
---

# fortimanager_object_webfilter_urlfilter_entries_sort
Sort for object_webfilter urlfilter_entries.

```hcl
resource "fortimanager_object_webfilter_urlfilter_entries_sort" "test" {
	sortby        = "id"
