...
* `ap_bgscan_disable_end` - Ap-Bgscan-Disable-End. (`ver FortiManager <= 6.4 and Controlled FortiOS <= 6.2`)
...
* `ap_bgscan_disable_start` - Ap-Bgscan-Disable-Start. (`ver FortiManager <= 6.4 and Controlled FortiOS <= 6.2`)
