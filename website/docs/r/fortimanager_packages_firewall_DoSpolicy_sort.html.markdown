...
layout: "fortimanager"
page_title: "FortiManager: fortimanager_packages_firewall_DoSpolicy_sort"
description: |-
  Sort for packages firewall_DoS-policy.
---

# fortimanager_packages_firewall_DoSpolicy_sort
Sort for packages firewall_DoS-policy.

```hcl
resource "fortimanager_packages_firewall_DoSpolicy_sort" "test" {
	sortby        = "policyid"
