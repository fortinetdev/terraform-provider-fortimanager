...
layout: "fortimanager"
page_title: "FortiManager: fortimanager_object_dlp_filepattern_entries_sort"
description: |-
  Sort for object_dlp filepattern_entries.
---

# fortimanager_object_dlp_filepattern_entries_sort
Sort for object_dlp filepattern_entries.

```hcl
resource "fortimanager_object_dlp_filepattern_entries_sort" "test" {
	sortby        = "pattern"
