...
layout: "fortimanager"
page_title: "FortiManager: fortimanager_object_wirelesscontroller_apcfgprofile_commandlist_sort"
description: |-
  Sort for object_wireless-controller apcfg-profile_command-list.
---

# fortimanager_object_wirelesscontroller_apcfgprofile_commandlist_sort
Sort for object_wireless-controller apcfg-profile_command-list.

```hcl
resource "fortimanager_object_wirelesscontroller_apcfgprofile_commandlist_sort" "test" {
	sortby        = "id"
