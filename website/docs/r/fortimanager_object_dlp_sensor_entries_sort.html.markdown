...
layout: "fortimanager"
page_title: "FortiManager: fortimanager_object_dlp_sensor_entries_sort"
description: |-
  Sort for object_dlp sensor_entries.
---

# fortimanager_object_dlp_sensor_entries_sort
Sort for object_dlp sensor_entries.

```hcl
resource "fortimanager_object_dlp_sensor_entries_sort" "test" {
	sortby        = "id"
