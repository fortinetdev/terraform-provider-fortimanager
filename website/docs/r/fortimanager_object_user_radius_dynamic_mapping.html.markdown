...
layout: "fortimanager"
page_title: "FortiManager: fortimanager_object_user_radius_dynamic_mapping"
description: |-
...
~> This resource is a sub resource for variable `dynamic_mapping` of resource `fortimanager_object_user_radius`. Conflict and overwrite may occur if use both of them.
The following variables have sub resource. Avoid using them together, otherwise conflicts and overwrites may occur.
>- `accounting_server`: `fortimanager_object_user_radius_dynamic_mapping_accountingserver`
...
$ terraform import fortimanager_object_user_radius_dynamic_mapping.labelname {{_scope.name}}.{{_scope.vdom}}
