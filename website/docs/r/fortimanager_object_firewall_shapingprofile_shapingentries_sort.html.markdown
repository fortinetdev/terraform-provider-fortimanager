...
layout: "fortimanager"
page_title: "FortiManager: fortimanager_object_firewall_shapingprofile_shapingentries_sort"
description: |-
  Sort for object_firewall shaping-profile_shaping-entries.
---

# fortimanager_object_firewall_shapingprofile_shapingentries_sort
Sort for object_firewall shaping-profile_shaping-entries.

```hcl
resource "fortimanager_object_firewall_shapingprofile_shapingentries_sort" "test" {
	sortby        = "id"
