...
layout: "fortimanager"
page_title: "FortiManager: fortimanager_object_casb_saasapplication_sort"
description: |-
  Sort for object_casb saas-application.
---

# fortimanager_object_casb_saasapplication_sort
Sort for object_casb saas-application.

```hcl
resource "fortimanager_object_casb_saasapplication_sort" "test" {
	sortby        = "name"
