...
layout: "fortimanager"
page_title: "FortiManager: fortimanager_packages_firewall_interfacepolicy_sort"
description: |-
  Sort for packages firewall_interface-policy.
---

# fortimanager_packages_firewall_interfacepolicy_sort
Sort for packages firewall_interface-policy.

```hcl
resource "fortimanager_packages_firewall_interfacepolicy_sort" "test" {
	sortby        = "policyid"
